...
RET_CODE gedraw_drawpixel(PGUI_REGION prgn,PGUI_POINT p_pos,UINT32 param);
RET_CODE gedraw_drawline(PGUI_REGION prgn,PGUI_POINT p_start,PGUI_POINT p_end,UINT32 param);
RET_CODE gedraw_lineto(PGUI_REGION prgn,PGUI_POINT p_start,PGUI_POINT p_end,UINT32 param);
RET_CODE gedraw_fillrect(PGUI_REGION prgn,PGUI_RECT p_rect,UINT32 param);
RET_CODE gedraw_fillroundrect(PGUI_REGION prgn,PGUI_RECT p_frm,PGUI_RECT p_corner,UINT32 param);
RET_CODE gedraw_drawbmp(PGUI_REGION prgn,PGUI_RECT p_frm,UINT32 param);
RET_CODE gedraw_renderbmp(PGUI_REGION prgn,PGUI_RECT pfrm,UINT32 param);
RET_CODE gedraw_drawfont(PGUI_REGION prgn,PGUI_RECT p_frm,UINT32 param);
