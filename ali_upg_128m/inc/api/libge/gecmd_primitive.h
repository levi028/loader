...
RET_CODE gecmd_drawpixel(PGUI_REGION prgn,PGUI_POINT p_pos,UINT32 param);
RET_CODE gecmd_drawline(PGUI_REGION prgn,PGUI_POINT p_start,PGUI_POINT p_end,UINT32 param);
RET_CODE gecmd_lineto(PGUI_REGION prgn,PGUI_POINT p_start,PGUI_POINT p_end,UINT32 param);
RET_CODE gecmd_fillrect(PGUI_REGION prgn,PGUI_RECT p_rect,UINT32 param);
RET_CODE gecmd_fillroundrect(PGUI_REGION prgn,PGUI_RECT p_frm,PGUI_RECT p_corner,UINT32 param);
RET_CODE gecmd_drawbmp(PGUI_REGION prgn,PGUI_RECT p_frm,UINT32 param);
RET_CODE gecmd_renderbmp(PGUI_REGION prgn,PGUI_RECT pfrm,UINT32 param);
RET_CODE gecmd_drawfont(PGUI_REGION prgn,PGUI_RECT p_frm,UINT32 param);
