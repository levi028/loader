...
#ifdef DHCP_SUCCESS_CALLBACK  /* Ali modified, 2013-3-13*/
  void (*dhcp_success_callback)(struct netif *netif);
#endif /****DHCP_SUCCESS_CALLBACK****/
};
...
err_t dhcp_start_with_callback(struct netif *netif, void (*dhcp_success_callback)(struct netif *netif));
err_t dhcp_set_success_callback(struct netif *netif, void (*dhcp_success_callback)(struct netif *netif));
#endif /****Ali modified****/
