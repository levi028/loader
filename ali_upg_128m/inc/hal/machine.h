...
#define dis_sr           0x14000000      // Register SR value, disable interrupt
#define en_sr            0x1400ff01      // Register SR value, enable interrupt
...
#define read_32bit_gpr_register(source) \
    ...
    #if (SYS_CPU_MODULE == CPU_MIPS74KF)
   ...
   #define read_32bit_cp0_register_fix(x, source)    \
    ({                                \
            __asm__ __volatile__(                    \
        ".set\tpush\n\t"                        \
        ".set\treorder\n\t"                        \
...
#define DEV_LEVEL_0                (DEV_NIM|DEV_TVE|DEV_DMX1|DEV_DMX0|DEV_PCI|DEV_UART1|DEV_UART0|\
                                    DEV_SCR1|DEV_SCR0|DEV_VE|DEV_IDE|DEV_CI|DEV_SCB)

/* Device list for IR, panel and two UART work only power save */
#define DEV_LEVEL_1                (DEV_NIM|DEV_TVE|DEV_DMX1|DEV_DMX0|DEV_PCI|DEV_SCR1|DEV_SCR0|DEV_VE|\
                                    DEV_IDE|DEV_CI|DEV_SCB)
...
#define SYS_FIRST_BOOT_REG_2                          0x10//0xb8000010 bit[0] = 1, the first boot is done.
#define SYS_FIRST_BOOT_BIT                                0x1
#define FIRST_BOOT_FLAG                                     0xa4
#define MAIN_FIRST_BOOT_FLAG_ADDR                  0xb8055fe0
#define SEE_FIRST_BOOT_FLAG_ADDR                    0xb8055fe4
#define COLD_BOOT_FLAG                                     0x434F4C44;//'C'----0x43; 'O'----0x4F; 'L'----0x4C; 'D'----0x44.
#define FAST_STANDBY_SUPPORT_FLAG                  0x52455445//'R'----0x52; 'E'----0x45; 'T'----0x54; 'E'----0x45.
#define FAST_STANDBY_SUPPORT_FLAG_ADDR        0xB8055FEC
#ifdef __cplusplus
 }
#endif
