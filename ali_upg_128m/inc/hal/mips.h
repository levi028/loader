...
#if defined(_MIPS_4_3_) && (_RD_DEBUG_)

/* The mips-4.3 can not support the ehb instruction
   Only in Debug mode, HB can be defined to several nop instruction */
...
/* If in release version,  HB should be defined to ehb instruction,
   The ehb instruction is safer for hazard barrier */
#define HB ehb
