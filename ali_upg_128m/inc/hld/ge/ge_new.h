...
RET_CODE ge_io_ctrl_ext(struct ge_device *dev, UINT32 layer_id, UINT32 dw_cmd, UINT32 dw_param);
...
RET_CODE ge_cmd_list_start(struct ge_device *dev, ge_cmd_list_hdl cmd_list, BOOL b_priority, BOOL sync);
RET_CODE ge_cmd_list_stop(struct ge_device *dev, ge_cmd_list_hdl cmd_list, BOOL b_priority, BOOL sync);
...
RET_CODE ge_set_clut_update(struct ge_device *dev, UINT32 cmd_pos, BOOL b_update);
...
RET_CODE ge_enable_bitmask(struct ge_device *dev, UINT32 cmd_pos, BOOL b_enable);
RET_CODE ge_set_bitmask(struct ge_device *dev, UINT32 cmd_pos, UINT32 bitmask);

RET_CODE ge_enable_dither(struct ge_device *dev, UINT32 cmd_pos, BOOL b_enable);
