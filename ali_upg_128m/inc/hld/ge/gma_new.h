...
RET_CODE ge_gma_show_onoff(struct ge_device *dev, UINT32 layer_id, BOOL b_on_off);
...
RET_CODE ge_gma_modify_pallette(struct ge_device *, UINT32 layer_id, UINT8 u_index, UINT8 alpha, UINT8 u_y, UINT8 u_cb, UINT8 u_cr, const ge_pal_attr_t *pattr);
...
RET_CODE ge_gma_show_region(struct ge_device *, UINT32 layer_id, UINT32 region_id, BOOL b_on_off);
