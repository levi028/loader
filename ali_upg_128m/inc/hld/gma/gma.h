...
enum GMA_FORMAT
{
    ...
    gma_format_ycb_cr444 = 0x10,
    gma_format_ycb_cr422 = 0x11,
    gma_format_ycb_cr420 = 0x12,
    gma_format_aycb_cr8888 = 0x13,
...
#define GMA_IO_SET_TRANS_COLOR              0x00000006
#define GMA_IO_GET_REGION_INFO              0x00000007
#define GMA_IO_CREATE_REGION                0x00000008
#define GMA_IO_GET_DISPLAY_RECT             0x00000009
#define GMA_IO_SET_DISPLAY_RECT             0x0000000A

#define GMA_IO_SET_CLIP_RECT			    0x0000000B
#define GMA_IO_SET_CLIP_MODE			    0x0000000C
...
struct gma_device
{
    ...
    RET_CODE (*set_region_to_cmd_list)(struct gma_device *dev, int reg_id, UINT32 cmd_list);
    RET_CODE (*region_fill)(struct gma_device *dev, int reg_id, struct gma_rect *rect, int color);
