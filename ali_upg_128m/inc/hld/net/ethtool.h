...
#define MAC_DLL_RESET        0x1003  /* DLL PD reset patch for APP for ALi Phy (eg:38/39) */
#define MAC_DESC_NUM_SET     0x1004  /* set DESC NUM */
#define MAC_LINKLED_GPIO_SET 0x1005  /* set link led gpio num */
