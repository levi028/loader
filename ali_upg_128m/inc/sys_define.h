...
#define CAS_C1900A                    (SW_TYPE_CA + 1)
#define CAS_C2000A                    (SW_TYPE_CA + 2)
#define CAS_C0500A                    (SW_TYPE_CA + 3)
#define CAS_C1800A                (SW_TYPE_CA + 4)
#define CAS_C2100A                    (SW_TYPE_CA + 5)
#define CAS_CONAX                (SW_TYPE_CA + 6)
#define CAS_C2200A                    (SW_TYPE_CA + 7)
#define CAS_C1200A                    (SW_TYPE_CA + 8)
#define CAS_C2300A3                (SW_TYPE_CA + 9)
#define CAS_C2300A30A                (SW_TYPE_CA + 10)
#define CAS_C2300A                (SW_TYPE_CA + 11)
#define CAS_C0400A                (SW_TYPE_CA + 12)
#define CAS_C1700A                (SW_TYPE_CA + 13)
#define CAS_C2400A                    (SW_TYPE_CA + 14)
#define CAS_C0200A                    (SW_TYPE_CA + 15)
...
#define ALI_S3505               (HW_TYPE_CHIP + 80)
#define ALI_C3503C              (HW_TYPE_CHIP + 81)
#define ALI_S3821B              (HW_TYPE_CHIP + 82)
#define ALI_C3503D              (HW_TYPE_CHIP + 83)
#define ALI_C3505               (ALI_S3505)
#define ALI_C3821B              (ALI_S3821B)
#define ALI_C3702               (HW_TYPE_CHIP + 84)
#define ALI_C3711C				(HW_TYPE_CHIP + 85)
...
#define ALI_C3922               (ALI_ARM_CHIP + 2)
...
#define hw_ali_s00_es_v5          (HW_TYPE_BOARD + 91)//Canal+
#define hw_ali_s00_es_v1        (HW_TYPE_BOARD + 92)
#define hw_ali_s00_es_v2        (HW_TYPE_BOARD + 93)//model 1
#define hw_ali_s00_es_v3        (HW_TYPE_BOARD + 94)//model 2= model 1 + S-Video
#define hw_ali_s00_es_v4        (HW_TYPE_BOARD + 95)//model 2= model 1 + S-Video
#define HW_ALI_DEMO_ZARLINK        (HW_TYPE_BOARD + 96)
#define hw_ali_s01_board            (HW_TYPE_BOARD + 97)
#define hw_ali_g00_board_v1            (HW_TYPE_BOARD + 98)
#define hw_ali_g00_board_v2            (HW_TYPE_BOARD + 99)
#define HW_ALI_DEMO_AFA            (HW_TYPE_BOARD + 100)
#define hw_ali_m00_board            (HW_TYPE_BOARD + 101)
#define hw_ali_i00_board            (HW_TYPE_BOARD + 102)
#define HW_ALI_DVR            (HW_TYPE_BOARD + 103)
#define hw_ali_a00_board_v1        (HW_TYPE_BOARD + 104) //060222 yuchun
#define hw_ali_p01_board            (HW_TYPE_BOARD + 105)
#define hw_ali_h00_board_v1        (HW_TYPE_BOARD + 106) //060302 hbchen
#define hw_ali_c00_board            (HW_TYPE_BOARD + 107)
#define hw_ali_p00_board            (HW_TYPE_BOARD + 108)    //060315 Angus
#define hw_ali_l00_board            (HW_TYPE_BOARD + 109)    //060411 yuchun
#define hw_ali_d00_board            (HW_TYPE_BOARD + 110)    //060419 Ming Yi
#define BOARD_M3329_P00            (HW_TYPE_BOARD + 111)    //060612 Tom Yang
#define hw_ali_a00_3101_board    (HW_TYPE_BOARD + 112)    //060612 Tom Yang
#define BOARD_C3006_PNPES    (HW_TYPE_BOARD + 113)
#define hw_ali_g00_board_m3101    (HW_TYPE_BOARD + 114)
...
#define hw_ali_s00_m3101_es_v1        (HW_TYPE_BOARD + 127)//M3101
...
#define board_s3202_c3069_hsc2000lv_a    (HW_TYPE_BOARD + 5001)
...
#define BOARD_DB_M3315_01V01        (HW_TYPE_BOARD + 20069)
#define BOARD_DB_M3715_01V03        (HW_TYPE_BOARD + 20070)
#define BOARD_DB_M3823_02V01        (HW_TYPE_BOARD + 20071)
#define BOARD_DB_M3715_04V01        (HW_TYPE_BOARD + 20072)
#define BOARD_DB_M3515_01V04        (HW_TYPE_BOARD + 20073)
#define BOARD_SB_M3521_01V01		(HW_TYPE_BOARD + 20075)
#define BOARD_SB_M3527_01V01		(HW_TYPE_BOARD + 20076)
#define BOARD_DB_M3521_01V01		(HW_TYPE_BOARD + 20077)
#define BOARD_DB_M3526_01V01		(HW_TYPE_BOARD + 20078)
#define BOARD_DB_M3527_01V01		(HW_TYPE_BOARD + 20079)
#define BOARD_DB_M3727_01V01		(HW_TYPE_BOARD + 20080)
#define BOARD_DB_M3627_02V01		(HW_TYPE_BOARD + 20081)
#define BOARD_DB_M3727_02V01		(HW_TYPE_BOARD + 20082)
#define BOARD_DB_M3626_01V01		(HW_TYPE_BOARD + 20083)
#define BOARD_SB_M3529_01V01		(HW_TYPE_BOARD + 20084)
#define BOARD_DB_M3529_01V01		(HW_TYPE_BOARD + 20085)
#define BOARD_DB_M3712_01V01        (HW_TYPE_BOARD + 20086)
#define BOARD_DB_M3712L_01V01       (HW_TYPE_BOARD + 20087)
#define BOARD_DB_M3528_01V01        (HW_TYPE_BOARD + 20088)
#define BOARD_DB_M3518_01V01        (HW_TYPE_BOARD + 20089)
#define BOARD_SB_M3528_02V01        (HW_TYPE_BOARD + 20090)
#define BOARD_DB_M3728_01V01        (HW_TYPE_BOARD + 20091)
#define BOARD_DB_M3721L_01V01       (HW_TYPE_BOARD + 20092)
#define BOARD_DB_M3711B_01V01      (HW_TYPE_BOARD + 20093)
#define BOARD_DB_M3711C_01V01      (HW_TYPE_BOARD + 20094)
#define BOARD_DB_M3721_02V01       (HW_TYPE_BOARD + 20095)
...
#define MN88473				(LLD_DEV_TYPE_DEM + 44) //dvb-t2
#define CXD2856				(LLD_DEV_TYPE_DEM + 45) //dvb-t2/T/ISDBT
...
#define CXD2872         	(LLD_DEV_TYPE_TUN + 104) //DVBT2
#define RT850         	(LLD_DEV_TYPE_TUN + 105) //DVB-T2, DVBT, ISDB-T DVBC
#define RT836       		(LLD_DEV_TYPE_TUN + 106) //DVBC
#define ATBM2040       	(LLD_DEV_TYPE_TUN + 107) //DVBC
#define ATBM253       	(LLD_DEV_TYPE_TUN + 108) //DVBC
...
#define ali_l00_00                (ACC_DEV_TYPE_IRP + 63)
#define C303101    (ACC_DEV_TYPE_IRP + 64)
#define C300200    (ACC_DEV_TYPE_IRP + 65)
#define ALI_00                    (ACC_DEV_TYPE_IRP + 66)
#define ali_g00_01                (ACC_DEV_TYPE_IRP + 67)
#define ali_s01_008                (ACC_DEV_TYPE_IRP + 68)
#define ali_p00_00                (ACC_DEV_TYPE_IRP + 69)
#define ali_a00_00                (ACC_DEV_TYPE_IRP + 70)
#define C3006_01    (ACC_DEV_TYPE_IRP + 71)
#define ali_g00_04                (ACC_DEV_TYPE_IRP + 72)
#define C3006_02    (ACC_DEV_TYPE_IRP + 73)
#define ali_d00_00               (ACC_DEV_TYPE_IRP + 74)
