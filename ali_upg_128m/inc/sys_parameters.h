/*
    Description: This file is used to define the parameters' position in binary code,
    the values in which is referenced both by bootloader and main code.
    History:
...
#define CHUNKID_OTA_PARA   0x11EE0200
...
/* Used to define bootloader, length 2 bytes in big endian:
   ...
   For example : if open logo in bootload, and display format is PAL, and source picture is 480,
   then it should be set to 0x81e0.
*/
