...
./util.sh extract --output=$OUT_FILE4 --input_offset=2048 $IN_FILE 12032
echo "5.extract boot_aux_code_area_sig data..."
./util.sh extract --output=$OUT_FILE5 --input_offset=14080 $IN_FILE 256
echo "6.extract boot_unchecked_area data..."
./util.sh extract --output=$OUT_FILE6 --input_offset=14336 $IN_FILE 8192
echo "7.extract boot_code_area data..."
./util.sh extract --output=$OUT_FILE7 --input_offset=22528 $IN_FILE $(($IN_FILE_SIZE-22528-256))
