...
rm ${obj_dir}/Sabbat_s3702.*.out
#rm ${obj_dir}/see_sabbat_s3702.*.out

cp -vf ${obj_dir}/Sabbat_s3702.out ${obj_dir}/Sabbat_s3702.${date_and_time}.out
#cp -vf ${obj_dir}/see_sabbat_s3702.out ${obj_dir}/see_sabbat_s3702.${date_and_time}.out

eval sed -i 's/Sabbat_s3702.*\.out/Sabbat_s3702.${date_and_time}\.out/g' ${obj_dir}/*.ini
