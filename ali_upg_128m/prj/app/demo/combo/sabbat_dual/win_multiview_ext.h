...
*
****************************************************************************/
#ifndef _WIN_MULTIVIEW_EXT_H_
#define _WIN_MULTIVIEW_EXT_H_

#define    MULTI_VIEW_X_COUNT        1
...
#if(4 == MULTI_VIEW_COUNT)
//vidoe position
#define    MV_VIDEO_LEFT                (CNT_MV_L+6)
#define    MV_VIDEO_TOP                (CNT_MV_T+4)

#define    MV_VIDEO_WIDTH                (260-2)//WIN_MV_RECT_WIDTH
#define    MV_VIDEO_HEIGHT                (156-38)//(WIN_MV_RECT_HEIGHT + WIN_MV_TXT_HEIGHT -2)
//#define    MV_VIDEO_HEIGHT                144//(WIN_MV_RECT_HEIGHT + WIN_MV_TXT_HEIGHT -2)
#define    TXT_MV_X_SHIFT            260//210//WIN_MV_RECT_WIDTH
#define    TXT_MV_Y_SHIFT            156//(WIN_MV_RECT_HEIGHT + WIN_MV_TXT_HEIGHT -2)

//Matrix Box
#define    MTB_MV_L        (CNT_MV_L+6)
#define    MTB_MV_T        (CNT_MV_T+TXT_MV_Y_SHIFT-38)
...
#define    PIP_TXT_W            (CNT_MV_W-TXT_MV_X_SHIFT-6 )
#define    PIP_TXT_H            0//50
#define    PIP_TXT_L            (CNT_MV_L+TXT_MV_X_SHIFT+6)
#define    PIP_TXT_T            (CNT_MV_T+CNT_MV_H-PIP_TXT_H+4)
