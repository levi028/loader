                             ...
                             long *param_longp)
{
  ...
  case CURLINFO_RTSP_CSEQ_RECV:
    *param_longp = data->state.rtsp_CSeq_recv;
    break;
  case CURLINFO_CUR_SPEED_DOWNLOAD:
    *param_longp =  data->progress.current_speed;
    break;  

  case CURLINFO_SEEK_FLAG:
    *param_longp = data->set.ulseekflag;
    break;
    
   case CURLINFO_SEEK_INFO:
    *param_longp = data->set.ulseekinfo;
    break;
  case  CURLINFO_GENERIC_PROTO:
  	*param_longp = (long)(data->state.proto.generic);
  	break;
    default:
    return CURLE_BAD_FUNCTION_ARGUMENT;
  }
                               ...
                               double *param_doublep)
{
  ...
  case CURLINFO_CONTENT_LENGTH_DOWNLOAD:
        *(long long*)param_doublep = (data->progress.flags & PGRS_DL_SIZE_KNOWN) ?
  ...
  case CURLINFO_REDIRECT_TIME:
    *param_doublep =  data->progress.t_redirect;
    ...
    case CURLINFO_TIME_LENGTH:
     *param_doublep = data->set.dtimelength;
    break;
    
    case CURLINFO_SEEK_TIME:
     *param_doublep = data->set.dseektime;
    break;

    case CURLINFO_CURRENT_POS:
      *(long long*)param_doublep = data->set.sllcurrentpos;
        break;
