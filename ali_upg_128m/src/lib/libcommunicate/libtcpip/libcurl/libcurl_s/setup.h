...
#define HAVE_CONFIG_H            // Add for ALi porting
...
#include <api/libcurl/curlbuild.h>

/*
 * Compile time sanity checks must also be done when building the library.
 */

#include <api/libcurl/curlrules.h>
...
#include <api/libcurl/stdcheaders.h>
#endif
