...
#define PORT_MXXXM   1755
#define PORT_MXXXMH  80
...
/* Here follows boolean settings that define how to behave during
  ...
  bool rtmp_livestream;  /* play a rtmp livestream*/
  long rtmp_starttime;    /* play start time*/
  long rtmp_stoptime;    /* play stop time*/
  long rtmp_timeout;    /* connect or recv timeout*/
  
  unsigned long ulseekflag;
  unsigned long ulseekinfo;
  double dtimelength;
  double dseektime;  
  long long sllcurrentpos;
  bool   not_strip_urlparam;
};
