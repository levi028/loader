...
#include <api/libxml2/xmlschemas.h>
#include <api/libxml2/schemasInternals.h>
#include <api/libxml2/xmlschemastypes.h>
#include <api/libxml2/xmlautomata.h>
#include <api/libxml2/xmlregexp.h>
#include <api/libxml2/dict.h>
#include <api/libxml2/encoding.h>
#include <api/libxml2/xmlIO.h>
#ifdef LIBXML_PATTERN_ENABLED
#include <api/libxml2/pattern.h>
#endif
#ifdef LIBXML_READER_ENABLED
#include <api/libxml2/xmlreader.h>
#endif
                     ...
                     xmlNodePtr node)
{
    ...
    */
    ...
    if (namespaceName != NULL) {
    /*
    * 1.1 If the namespace [attribute] is present, then its actual value * must not match the actual value of the enclosing <schema>'s
