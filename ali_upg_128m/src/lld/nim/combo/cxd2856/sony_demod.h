...
------------------------------------------------------------------------------*/
#if 1 //ali modify
#define SONY_DRIVER_BUILD_OPTION_CXD2856
...
//#define SONY_DEMOD_SUPPORT_DVBC                /**< Driver supports DVBC(J.83A). */ ali add
//#define SONY_DEMOD_SUPPORT_DVBC2               /**< Driver supports DVBC2(J.382). */ ali add
//#define SONY_DEMOD_SUPPORT_DVBS_S2             /**< Driver supports DVBS and S2. */ ali add
#define SONY_DEMOD_SUPPORT_ISDBT               /**< Driver supports ISDBT. */
//#define SONY_DEMOD_SUPPORT_ISDBC               /**< Driver supports ISDBC(J.83C). */ ali add
//#define SONY_DEMOD_SUPPORT_ISDBS               /**< Driver supports ISDBS. */ ali add
//#define SONY_DEMOD_SUPPORT_J83B                /**< Driver supports J.83B. */ ali add
...
typedef struct sony_demod_t {
	/***********   ali data *****************/
	struct 	COFDM_TUNER_CONFIG_API dvbt_config;
	UINT8  	t2_signal;        	//0:DVB-T signal, 1:DVB-T2 signal.
	UINT32 	tuner_id;
	UINT32 	Frequency;
	OSAL_ID flag_id;
	OSAL_ID i2c_mutex_id;
	OSAL_ID demodMode_mutex_id;
