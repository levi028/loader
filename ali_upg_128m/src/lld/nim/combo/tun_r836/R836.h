...
R840_ErrCode R840_AGC_Slow(void);
...
//--------- test function -----------//
extern UINT8 R840_RingPll_Check(void);
extern UINT8 R840_UL_TF_Check(void);
extern UINT8 R840_I2C_Check(void);
extern UINT8 R840_IMR_Check(void);
//extern UINT8 R840_Dump_Data(void);
extern UINT8 R840_IC_Check(void); 
extern UINT8   R840_Initial_done_flag;  
extern UINT8   R840_IMR_done_flag;   


R840_ErrCode I2C_Write_Len(I2C_LEN_TYPE *I2C_Info);
extern R840_ErrCode I2C_Read_Len(I2C_LEN_TYPE *I2C_Info);
extern R840_ErrCode I2C_Write(I2C_TYPE *I2C_Info);
