...
#define INT8    char		//¡Vaccroding to Current operation lib.
#define INT16  short		//¡Vaccroding to Current operation lib.
#define INT32 long		//¡Vaccroding to Current operation lib.

//joey, 20160106, for macro definition compatible.
#ifdef TRUE
#undef TRUE
#endif
...
#define R850_Delay_MS(R850_Tuner_Num, x_ms)  	osal_task_sleep(x_ms)
