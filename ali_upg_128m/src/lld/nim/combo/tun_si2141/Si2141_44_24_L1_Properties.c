/*************************************************************************************
 ...
 | To customize properties for your application please edit the settings in Si2141_44_24_User_Properties.c
 |---------------------------------------------------------------------------------------------------------------------|
...
/***********************************************************************************************************************
  ...
  Behavior:  This function will only download the property if required.
               Conditions to download the property are:
                ...
                - The propertyWriteMode is set to Si2141_44_24_DOWNLOAD_ALWAYS
                - The property is unknown to Si2141_44_24_PackProperty (this may be useful for debug purpose)
...
unsigned char Si2141_44_24_L1_SetProperty         (L1_Si2141_44_24_Context *api, unsigned int prop_code, int  data) {
    ...
    return Si2141_44_24_L1_SET_PROPERTY (api, reserved, prop_code, data);
}
/***********************************************************************************************************************
  Si2141_44_24_L1_GetProperty function
...
unsigned char Si2141_44_24_L1_GetProperty         (L1_Si2141_44_24_Context *api, unsigned int prop_code, int *data) {
    unsigned char  reserved          = 0;
    unsigned char res;
    res = Si2141_44_24_L1_GET_PROPERTY (api, reserved, prop_code);
    *data = api->rsp->get_property.data;
    return res;
}
 /***********************************************************************************************************************
  Si2141_44_24_L1_SetProperty2 function
  Use:        Sets the property given the property code.
  Parameter: *api     the Si2141_44_24 context
  Parameter: prop     the property Id

  Returns:    NO_Si2141_44_24_ERROR if successful.
 ***********************************************************************************************************************/
unsigned char Si2141_44_24_L1_SetProperty2        (L1_Si2141_44_24_Context *api, unsigned int prop_code) {
    int data, res;
    char msg[1000];
    res = Si2141_44_24_PackProperty(api,api->prop, prop_code, &data);
    if (res != NO_Si2141_44_24_ERROR) {
      sprintf(msg, "\nSi2141_44_24_L1_SetProperty2: %s 0x%04x!\n\n", Si2141_44_24_L1_API_ERROR_TEXT(res), prop_code);
      SiTRACE(msg);
      SiERROR(msg);
      return res;
    }
    return Si2141_44_24_L1_SetProperty (api, prop_code , data);
  }
 /***********************************************************************************************************************
  Si2141_44_24_L1_GetProperty2 function
  Use:        property get function
              Used to call L1_GET_PROPERTY with the property Id provided.
  Parameter: *api     the Si2141_44_24 context
  Parameter: prop     the property Id
...
unsigned char Si2141_44_24_L1_GetProperty2        (L1_Si2141_44_24_Context *api, unsigned int prop_code) {
  int data, res;
  res = Si2141_44_24_L1_GetProperty(api, prop_code & 0xffff, &data);
  if (res != NO_Si2141_44_24_ERROR) {
    SiTRACE("Si2141_44_24_L1_GetProperty2: %s 0x%04x\n", Si2141_44_24_L1_API_ERROR_TEXT(res), prop_code);
    SiERROR(Si2141_44_24_L1_API_ERROR_TEXT(res));
    return res;
  }
  return Si2141_44_24_UnpackProperty(api,api->prop, prop_code, data);
}
/*****************************************************************************************
 NAME: Si2141_44_24_downloadCOMMONProperties
  DESCRIPTION: Setup Si2141_44_24 COMMON properties configuration
  This function will download all the COMMON configuration properties.
  The function Si2141_44_24_storeUserProperties should be called before the first call to this function.
...
int  Si2141_44_24_downloadCOMMONProperties      (L1_Si2141_44_24_Context *api) {
  SiTRACE("Si2141_44_24_downloadCOMMONProperties\n");
#ifdef    Si2141_44_24_CRYSTAL_TRIM_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_CRYSTAL_TRIM_PROP_CODE                ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_CRYSTAL_TRIM_PROP */
#ifdef    Si2141_44_24_XOUT_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_XOUT_PROP_CODE                        ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_XOUT_PROP */
return NO_Si2141_44_24_ERROR;
}
/*****************************************************************************************
 NAME: Si2141_44_24_downloadDTVProperties
  DESCRIPTION: Setup Si2141_44_24 DTV properties configuration
...
int  Si2141_44_24_downloadDTVProperties         (L1_Si2141_44_24_Context *api) {
  SiTRACE("Si2141_44_24_downloadDTVProperties\n");
#ifdef    Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP_CODE         ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP */
#ifdef    Si2141_44_24_DTV_AGC_SPEED_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_AGC_SPEED_PROP_CODE               ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_AGC_SPEED_PROP */
#ifdef    Si2141_44_24_DTV_CONFIG_IF_PORT_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_CONFIG_IF_PORT_PROP_CODE          ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_CONFIG_IF_PORT_PROP */
#ifdef    Si2141_44_24_DTV_EXT_AGC_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_EXT_AGC_PROP_CODE                 ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_EXT_AGC_PROP */
#ifdef    Si2141_44_24_DTV_IF_AGC_SPEED_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_IF_AGC_SPEED_PROP_CODE            ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_IF_AGC_SPEED_PROP */
#ifdef    Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP_CODE       ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP */
#ifdef    Si2141_44_24_DTV_INITIAL_AGC_SPEED_PERIOD_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_CODE) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_INITIAL_AGC_SPEED_PERIOD_PROP */
#ifdef    Si2141_44_24_DTV_INTERNAL_ZIF_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_INTERNAL_ZIF_PROP_CODE            ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_INTERNAL_ZIF_PROP */
#ifdef    Si2141_44_24_DTV_LIF_FREQ_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_LIF_FREQ_PROP_CODE                ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_LIF_FREQ_PROP */
#ifdef    Si2141_44_24_DTV_LIF_OUT_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_LIF_OUT_PROP_CODE                 ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_LIF_OUT_PROP */
#ifdef    Si2141_44_24_DTV_MODE_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_MODE_PROP_CODE                    ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_MODE_PROP */
#ifdef    Si2141_44_24_DTV_PGA_LIMITS_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_PGA_LIMITS_PROP_CODE              ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_PGA_LIMITS_PROP */
#ifdef    Si2141_44_24_DTV_PGA_TARGET_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_PGA_TARGET_PROP_CODE              ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_PGA_TARGET_PROP */
#ifdef    Si2141_44_24_DTV_RF_AGC_SPEED_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_RF_AGC_SPEED_PROP_CODE            ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_RF_AGC_SPEED_PROP */
#ifdef    Si2141_44_24_DTV_RF_TOP_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_RF_TOP_PROP_CODE                  ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_RF_TOP_PROP */
#ifdef    Si2141_44_24_DTV_RSQ_RSSI_THRESHOLD_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_RSQ_RSSI_THRESHOLD_PROP_CODE      ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_RSQ_RSSI_THRESHOLD_PROP */
#ifdef    Si2141_44_24_DTV_WB_AGC_SPEED_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_DTV_WB_AGC_SPEED_PROP_CODE            ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_DTV_WB_AGC_SPEED_PROP */
return NO_Si2141_44_24_ERROR;
}
/*****************************************************************************************
 NAME: Si2141_44_24_downloadTUNERProperties
  DESCRIPTION: Setup Si2141_44_24 TUNER properties configuration
...
int  Si2141_44_24_downloadTUNERProperties       (L1_Si2141_44_24_Context *api) {
  SiTRACE("Si2141_44_24_downloadTUNERProperties\n");
  if ((api->rsp->part_info.part == 24) ||  (api->rsp->part_info.part == 44))
  {
    #ifdef    Si2144_ACTIVE_LOOP_THROUGH_PROP
      if (Si2141_44_24_L1_SetProperty2(api, Si2144_ACTIVE_LOOP_THROUGH_PROP_CODE         ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
    #endif /* Si2144_ACTIVE_LOOP_THROUGH_PROP */
  }
#ifdef    Si2141_44_24_TUNER_BLOCKED_VCO_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_TUNER_BLOCKED_VCO_PROP_CODE           ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_TUNER_BLOCKED_VCO_PROP */
#ifdef    Si2141_44_24_TUNER_BLOCKED_VCO2_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_TUNER_BLOCKED_VCO2_PROP_CODE          ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_TUNER_BLOCKED_VCO2_PROP */
#ifdef    Si2141_44_24_TUNER_BLOCKED_VCO3_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_TUNER_BLOCKED_VCO3_PROP_CODE          ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_TUNER_BLOCKED_VCO3_PROP */
#ifdef    Si2141_44_24_TUNER_LO_INJECTION_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_TUNER_LO_INJECTION_PROP_CODE          ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_TUNER_LO_INJECTION_PROP */
    if (api->rsp->part_info.part == 41)
    {
        #ifdef    Si2141_TUNER_RETURN_LOSS_PROP
          if (Si2141_44_24_L1_SetProperty2(api, Si2141_TUNER_RETURN_LOSS_PROP_CODE           ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
        #endif /* Si2141_TUNER_RETURN_LOSS_PROP */
    }
    else if (api->rsp->part_info.part == 44)
    {
        #ifdef    Si2144_TUNER_RETURN_LOSS_PROP
          if (Si2141_44_24_L1_SetProperty2(api, Si2144_TUNER_RETURN_LOSS_PROP_CODE           ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
        #endif /* Si2144_TUNER_RETURN_LOSS_PROP */
    }
    if (api->rsp->part_info.part == 41)
    {
        #ifdef    Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP
          if (Si2141_44_24_L1_SetProperty2(api, Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_CODE  ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
        #endif /* Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP */
        #ifdef    Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP
          if (Si2141_44_24_L1_SetProperty2(api, Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP_CODE) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
        #endif /* Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP */
        #ifdef    Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP
          if (Si2141_44_24_L1_SetProperty2(api, Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP_CODE   ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
        #endif /* Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP */
    }
#ifdef    Si2141_44_24_WIDE_BAND_ATT_THRS_PROP
  if (Si2141_44_24_L1_SetProperty2(api, Si2141_44_24_WIDE_BAND_ATT_THRS_PROP_CODE          ) != NO_Si2141_44_24_ERROR) {return ERROR_Si2141_44_24_SENDING_COMMAND;}
#endif /* Si2141_44_24_WIDE_BAND_ATT_THRS_PROP */
return NO_Si2141_44_24_ERROR;
}
int  Si2141_44_24_downloadAllProperties         (L1_Si2141_44_24_Context *api) {
  Si2141_44_24_downloadCOMMONProperties      (api);
  Si2141_44_24_downloadDTVProperties         (api);
  Si2141_44_24_downloadTUNERProperties       (api);
  return 0;
}

/***********************************************************************************************************************
  Si2141_44_24_PackProperty function
  Use:        This function will pack all the members of a property into an integer for the SetProperty function.

  Parameter: *prop          the Si2141_44_24 property context
  Parameter:  prop_code     the property Id
  Parameter:  *data         an int to store the property data

  Returns:    NO_Si2141_44_24_ERROR if the property exists.
 ***********************************************************************************************************************/
unsigned char Si2141_44_24_PackProperty            (L1_Si2141_44_24_Context *api,Si2141_44_24_PropObj   *prop, unsigned int prop_code, int *data) {
    switch (prop_code) {
     ...
     case         Si2144_ACTIVE_LOOP_THROUGH_PROP_CODE:
      if (api->rsp->part_info.part == 41)
      {
          return ERROR_Si2141_44_24_UNKNOWN_PROPERTY;
      }
    ...
    #endif /*     Si2144_ACTIVE_LOOP_THROUGH_PROP */
    #ifdef        Si2141_44_24_CRYSTAL_TRIM_PROP
     case         Si2141_44_24_CRYSTAL_TRIM_PROP_CODE:
      *data = (prop->crystal_trim.xo_cap & Si2141_44_24_CRYSTAL_TRIM_PROP_XO_CAP_MASK) << Si2141_44_24_CRYSTAL_TRIM_PROP_XO_CAP_LSB ;
     break;
    #endif /*     Si2141_44_24_CRYSTAL_TRIM_PROP */
    #ifdef        Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP
     case         Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP_CODE:
      *data = (prop->dtv_agc_auto_freeze.thld    & Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP_THLD_MASK   ) << Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP_THLD_LSB  |
              (prop->dtv_agc_auto_freeze.timeout & Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_MASK) << Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP */
    #ifdef        Si2141_44_24_DTV_AGC_SPEED_PROP
     case         Si2141_44_24_DTV_AGC_SPEED_PROP_CODE:
      *data = (prop->dtv_agc_speed.if_agc_speed & Si2141_44_24_DTV_AGC_SPEED_PROP_IF_AGC_SPEED_MASK) << Si2141_44_24_DTV_AGC_SPEED_PROP_IF_AGC_SPEED_LSB  |
              (prop->dtv_agc_speed.agc_decim    & Si2141_44_24_DTV_AGC_SPEED_PROP_AGC_DECIM_MASK   ) << Si2141_44_24_DTV_AGC_SPEED_PROP_AGC_DECIM_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_AGC_SPEED_PROP */
    #ifdef        Si2141_44_24_DTV_CONFIG_IF_PORT_PROP
     case         Si2141_44_24_DTV_CONFIG_IF_PORT_PROP_CODE:
      *data = (prop->dtv_config_if_port.dtv_out_type & Si2141_44_24_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_MASK) << Si2141_44_24_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_CONFIG_IF_PORT_PROP */
    #ifdef        Si2141_44_24_DTV_EXT_AGC_PROP
     case         Si2141_44_24_DTV_EXT_AGC_PROP_CODE:
      *data = (prop->dtv_ext_agc.min_10mv & Si2141_44_24_DTV_EXT_AGC_PROP_MIN_10MV_MASK) << Si2141_44_24_DTV_EXT_AGC_PROP_MIN_10MV_LSB  |
              (prop->dtv_ext_agc.max_10mv & Si2141_44_24_DTV_EXT_AGC_PROP_MAX_10MV_MASK) << Si2141_44_24_DTV_EXT_AGC_PROP_MAX_10MV_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_EXT_AGC_PROP */
    #ifdef        Si2141_44_24_DTV_IF_AGC_SPEED_PROP
     case         Si2141_44_24_DTV_IF_AGC_SPEED_PROP_CODE:
      *data = (prop->dtv_if_agc_speed.attack & Si2141_44_24_DTV_IF_AGC_SPEED_PROP_ATTACK_MASK) << Si2141_44_24_DTV_IF_AGC_SPEED_PROP_ATTACK_LSB  |
              (prop->dtv_if_agc_speed.decay  & Si2141_44_24_DTV_IF_AGC_SPEED_PROP_DECAY_MASK ) << Si2141_44_24_DTV_IF_AGC_SPEED_PROP_DECAY_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_IF_AGC_SPEED_PROP */
    #ifdef        Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP
     case         Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP_CODE:
      *data = (prop->dtv_initial_agc_speed.if_agc_speed & Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP_IF_AGC_SPEED_MASK) << Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP_IF_AGC_SPEED_LSB  |
              (prop->dtv_initial_agc_speed.agc_decim    & Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP_AGC_DECIM_MASK   ) << Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP_AGC_DECIM_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP */
    #ifdef        Si2141_44_24_DTV_INITIAL_AGC_SPEED_PERIOD_PROP
     case         Si2141_44_24_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_CODE:
      *data = (prop->dtv_initial_agc_speed_period.period & Si2141_44_24_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_PERIOD_MASK) << Si2141_44_24_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_PERIOD_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_INITIAL_AGC_SPEED_PERIOD_PROP */
    #ifdef        Si2141_44_24_DTV_INTERNAL_ZIF_PROP
     case         Si2141_44_24_DTV_INTERNAL_ZIF_PROP_CODE:
      *data = (prop->dtv_internal_zif.atsc   & Si2141_44_24_DTV_INTERNAL_ZIF_PROP_ATSC_MASK  ) << Si2141_44_24_DTV_INTERNAL_ZIF_PROP_ATSC_LSB  |
              (prop->dtv_internal_zif.qam_us & Si2141_44_24_DTV_INTERNAL_ZIF_PROP_QAM_US_MASK) << Si2141_44_24_DTV_INTERNAL_ZIF_PROP_QAM_US_LSB  |
              (prop->dtv_internal_zif.dvbt   & Si2141_44_24_DTV_INTERNAL_ZIF_PROP_DVBT_MASK  ) << Si2141_44_24_DTV_INTERNAL_ZIF_PROP_DVBT_LSB  |
              (prop->dtv_internal_zif.dvbc   & Si2141_44_24_DTV_INTERNAL_ZIF_PROP_DVBC_MASK  ) << Si2141_44_24_DTV_INTERNAL_ZIF_PROP_DVBC_LSB  |
              (prop->dtv_internal_zif.isdbt  & Si2141_44_24_DTV_INTERNAL_ZIF_PROP_ISDBT_MASK ) << Si2141_44_24_DTV_INTERNAL_ZIF_PROP_ISDBT_LSB  |
              (prop->dtv_internal_zif.isdbc  & Si2141_44_24_DTV_INTERNAL_ZIF_PROP_ISDBC_MASK ) << Si2141_44_24_DTV_INTERNAL_ZIF_PROP_ISDBC_LSB  |
              (prop->dtv_internal_zif.dtmb   & Si2141_44_24_DTV_INTERNAL_ZIF_PROP_DTMB_MASK  ) << Si2141_44_24_DTV_INTERNAL_ZIF_PROP_DTMB_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_INTERNAL_ZIF_PROP */
    #ifdef        Si2141_44_24_DTV_LIF_FREQ_PROP
     case         Si2141_44_24_DTV_LIF_FREQ_PROP_CODE:
      *data = (prop->dtv_lif_freq.offset & Si2141_44_24_DTV_LIF_FREQ_PROP_OFFSET_MASK) << Si2141_44_24_DTV_LIF_FREQ_PROP_OFFSET_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_LIF_FREQ_PROP */
    #ifdef        Si2141_44_24_DTV_LIF_OUT_PROP
     case         Si2141_44_24_DTV_LIF_OUT_PROP_CODE:
      *data = (prop->dtv_lif_out.offset & Si2141_44_24_DTV_LIF_OUT_PROP_OFFSET_MASK) << Si2141_44_24_DTV_LIF_OUT_PROP_OFFSET_LSB  |
              (prop->dtv_lif_out.amp    & Si2141_44_24_DTV_LIF_OUT_PROP_AMP_MASK   ) << Si2141_44_24_DTV_LIF_OUT_PROP_AMP_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_LIF_OUT_PROP */
    #ifdef        Si2141_44_24_DTV_MODE_PROP
     case         Si2141_44_24_DTV_MODE_PROP_CODE:
      *data = (prop->dtv_mode.bw              & Si2141_44_24_DTV_MODE_PROP_BW_MASK             ) << Si2141_44_24_DTV_MODE_PROP_BW_LSB  |
              (prop->dtv_mode.modulation      & Si2141_44_24_DTV_MODE_PROP_MODULATION_MASK     ) << Si2141_44_24_DTV_MODE_PROP_MODULATION_LSB  |
              (prop->dtv_mode.invert_spectrum & Si2141_44_24_DTV_MODE_PROP_INVERT_SPECTRUM_MASK) << Si2141_44_24_DTV_MODE_PROP_INVERT_SPECTRUM_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_MODE_PROP */
    #ifdef        Si2141_44_24_DTV_PGA_LIMITS_PROP
     case         Si2141_44_24_DTV_PGA_LIMITS_PROP_CODE:
      *data = (prop->dtv_pga_limits.min & Si2141_44_24_DTV_PGA_LIMITS_PROP_MIN_MASK) << Si2141_44_24_DTV_PGA_LIMITS_PROP_MIN_LSB  |
              (prop->dtv_pga_limits.max & Si2141_44_24_DTV_PGA_LIMITS_PROP_MAX_MASK) << Si2141_44_24_DTV_PGA_LIMITS_PROP_MAX_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_PGA_LIMITS_PROP */
    #ifdef        Si2141_44_24_DTV_PGA_TARGET_PROP
     case         Si2141_44_24_DTV_PGA_TARGET_PROP_CODE:
      *data = (prop->dtv_pga_target.pga_target      & Si2141_44_24_DTV_PGA_TARGET_PROP_PGA_TARGET_MASK     ) << Si2141_44_24_DTV_PGA_TARGET_PROP_PGA_TARGET_LSB  |
              (prop->dtv_pga_target.override_enable & Si2141_44_24_DTV_PGA_TARGET_PROP_OVERRIDE_ENABLE_MASK) << Si2141_44_24_DTV_PGA_TARGET_PROP_OVERRIDE_ENABLE_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_PGA_TARGET_PROP */
    #ifdef        Si2141_44_24_DTV_RF_AGC_SPEED_PROP
     case         Si2141_44_24_DTV_RF_AGC_SPEED_PROP_CODE:
      *data = (prop->dtv_rf_agc_speed.attack & Si2141_44_24_DTV_RF_AGC_SPEED_PROP_ATTACK_MASK) << Si2141_44_24_DTV_RF_AGC_SPEED_PROP_ATTACK_LSB  |
              (prop->dtv_rf_agc_speed.decay  & Si2141_44_24_DTV_RF_AGC_SPEED_PROP_DECAY_MASK ) << Si2141_44_24_DTV_RF_AGC_SPEED_PROP_DECAY_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_RF_AGC_SPEED_PROP */
    #ifdef        Si2141_44_24_DTV_RF_TOP_PROP
     case         Si2141_44_24_DTV_RF_TOP_PROP_CODE:
      *data = (prop->dtv_rf_top.dtv_rf_top & Si2141_44_24_DTV_RF_TOP_PROP_DTV_RF_TOP_MASK) << Si2141_44_24_DTV_RF_TOP_PROP_DTV_RF_TOP_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_RF_TOP_PROP */
    #ifdef        Si2141_44_24_DTV_RSQ_RSSI_THRESHOLD_PROP
     case         Si2141_44_24_DTV_RSQ_RSSI_THRESHOLD_PROP_CODE:
      *data = (prop->dtv_rsq_rssi_threshold.lo & Si2141_44_24_DTV_RSQ_RSSI_THRESHOLD_PROP_LO_MASK) << Si2141_44_24_DTV_RSQ_RSSI_THRESHOLD_PROP_LO_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_RSQ_RSSI_THRESHOLD_PROP */
    #ifdef        Si2141_44_24_DTV_WB_AGC_SPEED_PROP
     case         Si2141_44_24_DTV_WB_AGC_SPEED_PROP_CODE:
      *data = (prop->dtv_wb_agc_speed.attack & Si2141_44_24_DTV_WB_AGC_SPEED_PROP_ATTACK_MASK) << Si2141_44_24_DTV_WB_AGC_SPEED_PROP_ATTACK_LSB  |
              (prop->dtv_wb_agc_speed.decay  & Si2141_44_24_DTV_WB_AGC_SPEED_PROP_DECAY_MASK ) << Si2141_44_24_DTV_WB_AGC_SPEED_PROP_DECAY_LSB ;
     break;
    #endif /*     Si2141_44_24_DTV_WB_AGC_SPEED_PROP */
    #ifdef        Si2141_44_24_TUNER_BLOCKED_VCO_PROP
     case         Si2141_44_24_TUNER_BLOCKED_VCO_PROP_CODE:
      *data = (prop->tuner_blocked_vco.vco_code & Si2141_44_24_TUNER_BLOCKED_VCO_PROP_VCO_CODE_MASK) << Si2141_44_24_TUNER_BLOCKED_VCO_PROP_VCO_CODE_LSB ;
     break;
    #endif /*     Si2141_44_24_TUNER_BLOCKED_VCO_PROP */
    #ifdef        Si2141_44_24_TUNER_BLOCKED_VCO2_PROP
     case         Si2141_44_24_TUNER_BLOCKED_VCO2_PROP_CODE:
      *data = (prop->tuner_blocked_vco2.vco_code & Si2141_44_24_TUNER_BLOCKED_VCO2_PROP_VCO_CODE_MASK) << Si2141_44_24_TUNER_BLOCKED_VCO2_PROP_VCO_CODE_LSB ;
     break;
    #endif /*     Si2141_44_24_TUNER_BLOCKED_VCO2_PROP */
    #ifdef        Si2141_44_24_TUNER_BLOCKED_VCO3_PROP
     case         Si2141_44_24_TUNER_BLOCKED_VCO3_PROP_CODE:
      *data = (prop->tuner_blocked_vco3.vco_code & Si2141_44_24_TUNER_BLOCKED_VCO3_PROP_VCO_CODE_MASK) << Si2141_44_24_TUNER_BLOCKED_VCO3_PROP_VCO_CODE_LSB ;
     break;
    #endif /*     Si2141_44_24_TUNER_BLOCKED_VCO3_PROP */
    #ifdef        Si2141_44_24_TUNER_LO_INJECTION_PROP
     case         Si2141_44_24_TUNER_LO_INJECTION_PROP_CODE:
      *data = (prop->tuner_lo_injection.band_1 & Si2141_44_24_TUNER_LO_INJECTION_PROP_BAND_1_MASK) << Si2141_44_24_TUNER_LO_INJECTION_PROP_BAND_1_LSB  |
              (prop->tuner_lo_injection.band_2 & Si2141_44_24_TUNER_LO_INJECTION_PROP_BAND_2_MASK) << Si2141_44_24_TUNER_LO_INJECTION_PROP_BAND_2_LSB  |
              (prop->tuner_lo_injection.band_3 & Si2141_44_24_TUNER_LO_INJECTION_PROP_BAND_3_MASK) << Si2141_44_24_TUNER_LO_INJECTION_PROP_BAND_3_LSB ;
     break;
    #endif /*     Si2141_44_24_TUNER_LO_INJECTION_PROP */
     case         Si2141_TUNER_RETURN_LOSS_PROP_CODE:
        ...
        {
             #ifdef        Si2144_TUNER_RETURN_LOSS_PROP
              *data = (prop->tuner_return_loss.reserved   & Si2144_TUNER_RETURN_LOSS_PROP_RESERVED_MASK  ) << Si2144_TUNER_RETURN_LOSS_PROP_RESERVED_LSB  |
    ...
    break;
    #ifdef        Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP
     case         Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_CODE:
      if ((api->rsp->part_info.part == 44) || (api->rsp->part_info.part == 24))
      {
          return ERROR_Si2141_44_24_UNKNOWN_PROPERTY;
      }
      *data = (prop->tuner_return_loss_optimize.thld                & Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_THLD_MASK               ) << Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_THLD_LSB  |
              (prop->tuner_return_loss_optimize.config              & Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_CONFIG_MASK             ) << Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_CONFIG_LSB  |
              (prop->tuner_return_loss_optimize.engagement_delay    & Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_ENGAGEMENT_DELAY_MASK   ) << Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_ENGAGEMENT_DELAY_LSB  |
              (prop->tuner_return_loss_optimize.disengagement_delay & Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_DISENGAGEMENT_DELAY_MASK) << Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_DISENGAGEMENT_DELAY_LSB ;
     break;
    #endif /*     Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP */
    #ifdef        Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP
     case         Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP_CODE:
      if ((api->rsp->part_info.part == 44) || (api->rsp->part_info.part == 24))
      {
          return ERROR_Si2141_44_24_UNKNOWN_PROPERTY;
      }
      *data = (prop->tuner_return_loss_optimize_2.thld             & Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP_THLD_MASK            ) << Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP_THLD_LSB  |
              (prop->tuner_return_loss_optimize_2.window           & Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP_WINDOW_MASK          ) << Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP_WINDOW_LSB  |
              (prop->tuner_return_loss_optimize_2.engagement_delay & Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP_ENGAGEMENT_DELAY_MASK) << Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP_ENGAGEMENT_DELAY_LSB ;
     break;
    #endif /*     Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP */
    #ifdef        Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP
     case         Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP_CODE:
      if ((api->rsp->part_info.part == 44) || (api->rsp->part_info.part == 24))
      {
          return ERROR_Si2141_44_24_UNKNOWN_PROPERTY;
      }
      *data = (prop->tuner_tf1_boundary_offset.tf1_boundary_offset & Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP_TF1_BOUNDARY_OFFSET_MASK) << Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP_TF1_BOUNDARY_OFFSET_LSB ;
     break;
    #endif /*     Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP */
    #ifdef        Si2141_44_24_WIDE_BAND_ATT_THRS_PROP
     case         Si2141_44_24_WIDE_BAND_ATT_THRS_PROP_CODE:
      *data = (prop->wide_band_att_thrs.wb_att_thrs & Si2141_44_24_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_MASK) << Si2141_44_24_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_LSB ;
     break;
    #endif /*     Si2141_44_24_WIDE_BAND_ATT_THRS_PROP */
    #ifdef        Si2141_44_24_XOUT_PROP
     case         Si2141_44_24_XOUT_PROP_CODE:
      *data = (prop->xout.amp & Si2141_44_24_XOUT_PROP_AMP_MASK) << Si2141_44_24_XOUT_PROP_AMP_LSB ;
     break;
    #endif /*     Si2141_44_24_XOUT_PROP */
     default : return ERROR_Si2141_44_24_UNKNOWN_PROPERTY; break;
    }
    return NO_Si2141_44_24_ERROR;
}
...
/***********************************************************************************************************************
  Si2141_44_24_UnpackProperty function
...
unsigned char Si2141_44_24_UnpackProperty          (L1_Si2141_44_24_Context *api,Si2141_44_24_PropObj   *prop, unsigned int prop_code, int  data) {
    ...
    #ifdef        Si2144_ACTIVE_LOOP_THROUGH_PROP
     case         Si2144_ACTIVE_LOOP_THROUGH_PROP_CODE:
               if (api->rsp->part_info.part == 41) /* LOOP_THROUGH is not supported for Si2141 */
               {
                   return ERROR_Si2141_44_24_UNKNOWN_PROPERTY;
               }
    ...
    #ifdef        Si2141_44_24_CRYSTAL_TRIM_PROP
     case         Si2141_44_24_CRYSTAL_TRIM_PROP_CODE:
               prop->crystal_trim.xo_cap = (data >> Si2141_44_24_CRYSTAL_TRIM_PROP_XO_CAP_LSB) & Si2141_44_24_CRYSTAL_TRIM_PROP_XO_CAP_MASK;
     break;
    #endif /*     Si2141_44_24_CRYSTAL_TRIM_PROP */
    #ifdef        Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP
     case         Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP_CODE:
               prop->dtv_agc_auto_freeze.thld    = (data >> Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP_THLD_LSB   ) & Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP_THLD_MASK;
               prop->dtv_agc_auto_freeze.timeout = (data >> Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_LSB) & Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP_TIMEOUT_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_AGC_AUTO_FREEZE_PROP */
    #ifdef        Si2141_44_24_DTV_AGC_SPEED_PROP
     case         Si2141_44_24_DTV_AGC_SPEED_PROP_CODE:
               prop->dtv_agc_speed.if_agc_speed = (data >> Si2141_44_24_DTV_AGC_SPEED_PROP_IF_AGC_SPEED_LSB) & Si2141_44_24_DTV_AGC_SPEED_PROP_IF_AGC_SPEED_MASK;
               prop->dtv_agc_speed.agc_decim    = (data >> Si2141_44_24_DTV_AGC_SPEED_PROP_AGC_DECIM_LSB   ) & Si2141_44_24_DTV_AGC_SPEED_PROP_AGC_DECIM_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_AGC_SPEED_PROP */
    #ifdef        Si2141_44_24_DTV_CONFIG_IF_PORT_PROP
     case         Si2141_44_24_DTV_CONFIG_IF_PORT_PROP_CODE:
               prop->dtv_config_if_port.dtv_out_type = (data >> Si2141_44_24_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_LSB) & Si2141_44_24_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_CONFIG_IF_PORT_PROP */
    #ifdef        Si2141_44_24_DTV_EXT_AGC_PROP
     case         Si2141_44_24_DTV_EXT_AGC_PROP_CODE:
               prop->dtv_ext_agc.min_10mv = (data >> Si2141_44_24_DTV_EXT_AGC_PROP_MIN_10MV_LSB) & Si2141_44_24_DTV_EXT_AGC_PROP_MIN_10MV_MASK;
               prop->dtv_ext_agc.max_10mv = (data >> Si2141_44_24_DTV_EXT_AGC_PROP_MAX_10MV_LSB) & Si2141_44_24_DTV_EXT_AGC_PROP_MAX_10MV_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_EXT_AGC_PROP */
    #ifdef        Si2141_44_24_DTV_IF_AGC_SPEED_PROP
     case         Si2141_44_24_DTV_IF_AGC_SPEED_PROP_CODE:
               prop->dtv_if_agc_speed.attack = (data >> Si2141_44_24_DTV_IF_AGC_SPEED_PROP_ATTACK_LSB) & Si2141_44_24_DTV_IF_AGC_SPEED_PROP_ATTACK_MASK;
               prop->dtv_if_agc_speed.decay  = (data >> Si2141_44_24_DTV_IF_AGC_SPEED_PROP_DECAY_LSB ) & Si2141_44_24_DTV_IF_AGC_SPEED_PROP_DECAY_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_IF_AGC_SPEED_PROP */
    #ifdef        Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP
     case         Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP_CODE:
               prop->dtv_initial_agc_speed.if_agc_speed = (data >> Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP_IF_AGC_SPEED_LSB) & Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP_IF_AGC_SPEED_MASK;
               prop->dtv_initial_agc_speed.agc_decim    = (data >> Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP_AGC_DECIM_LSB   ) & Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP_AGC_DECIM_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP */
    #ifdef        Si2141_44_24_DTV_INITIAL_AGC_SPEED_PERIOD_PROP
     case         Si2141_44_24_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_CODE:
               prop->dtv_initial_agc_speed_period.period = (data >> Si2141_44_24_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_PERIOD_LSB) & Si2141_44_24_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_PERIOD_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_INITIAL_AGC_SPEED_PERIOD_PROP */
    #ifdef        Si2141_44_24_DTV_INTERNAL_ZIF_PROP
     case         Si2141_44_24_DTV_INTERNAL_ZIF_PROP_CODE:
               prop->dtv_internal_zif.atsc   = (data >> Si2141_44_24_DTV_INTERNAL_ZIF_PROP_ATSC_LSB  ) & Si2141_44_24_DTV_INTERNAL_ZIF_PROP_ATSC_MASK;
               prop->dtv_internal_zif.qam_us = (data >> Si2141_44_24_DTV_INTERNAL_ZIF_PROP_QAM_US_LSB) & Si2141_44_24_DTV_INTERNAL_ZIF_PROP_QAM_US_MASK;
               prop->dtv_internal_zif.dvbt   = (data >> Si2141_44_24_DTV_INTERNAL_ZIF_PROP_DVBT_LSB  ) & Si2141_44_24_DTV_INTERNAL_ZIF_PROP_DVBT_MASK;
               prop->dtv_internal_zif.dvbc   = (data >> Si2141_44_24_DTV_INTERNAL_ZIF_PROP_DVBC_LSB  ) & Si2141_44_24_DTV_INTERNAL_ZIF_PROP_DVBC_MASK;
               prop->dtv_internal_zif.isdbt  = (data >> Si2141_44_24_DTV_INTERNAL_ZIF_PROP_ISDBT_LSB ) & Si2141_44_24_DTV_INTERNAL_ZIF_PROP_ISDBT_MASK;
               prop->dtv_internal_zif.isdbc  = (data >> Si2141_44_24_DTV_INTERNAL_ZIF_PROP_ISDBC_LSB ) & Si2141_44_24_DTV_INTERNAL_ZIF_PROP_ISDBC_MASK;
               prop->dtv_internal_zif.dtmb   = (data >> Si2141_44_24_DTV_INTERNAL_ZIF_PROP_DTMB_LSB  ) & Si2141_44_24_DTV_INTERNAL_ZIF_PROP_DTMB_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_INTERNAL_ZIF_PROP */
    #ifdef        Si2141_44_24_DTV_LIF_FREQ_PROP
     case         Si2141_44_24_DTV_LIF_FREQ_PROP_CODE:
               prop->dtv_lif_freq.offset = (data >> Si2141_44_24_DTV_LIF_FREQ_PROP_OFFSET_LSB) & Si2141_44_24_DTV_LIF_FREQ_PROP_OFFSET_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_LIF_FREQ_PROP */
    #ifdef        Si2141_44_24_DTV_LIF_OUT_PROP
     case         Si2141_44_24_DTV_LIF_OUT_PROP_CODE:
               prop->dtv_lif_out.offset = (data >> Si2141_44_24_DTV_LIF_OUT_PROP_OFFSET_LSB) & Si2141_44_24_DTV_LIF_OUT_PROP_OFFSET_MASK;
               prop->dtv_lif_out.amp    = (data >> Si2141_44_24_DTV_LIF_OUT_PROP_AMP_LSB   ) & Si2141_44_24_DTV_LIF_OUT_PROP_AMP_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_LIF_OUT_PROP */
    #ifdef        Si2141_44_24_DTV_MODE_PROP
     case         Si2141_44_24_DTV_MODE_PROP_CODE:
               prop->dtv_mode.bw              = (data >> Si2141_44_24_DTV_MODE_PROP_BW_LSB             ) & Si2141_44_24_DTV_MODE_PROP_BW_MASK;
               prop->dtv_mode.modulation      = (data >> Si2141_44_24_DTV_MODE_PROP_MODULATION_LSB     ) & Si2141_44_24_DTV_MODE_PROP_MODULATION_MASK;
               prop->dtv_mode.invert_spectrum = (data >> Si2141_44_24_DTV_MODE_PROP_INVERT_SPECTRUM_LSB) & Si2141_44_24_DTV_MODE_PROP_INVERT_SPECTRUM_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_MODE_PROP */
    #ifdef        Si2141_44_24_DTV_PGA_LIMITS_PROP
     case         Si2141_44_24_DTV_PGA_LIMITS_PROP_CODE:
               prop->dtv_pga_limits.min = (data >> Si2141_44_24_DTV_PGA_LIMITS_PROP_MIN_LSB) & Si2141_44_24_DTV_PGA_LIMITS_PROP_MIN_MASK;
               prop->dtv_pga_limits.max = (data >> Si2141_44_24_DTV_PGA_LIMITS_PROP_MAX_LSB) & Si2141_44_24_DTV_PGA_LIMITS_PROP_MAX_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_PGA_LIMITS_PROP */
    #ifdef        Si2141_44_24_DTV_PGA_TARGET_PROP
     case         Si2141_44_24_DTV_PGA_TARGET_PROP_CODE:
               prop->dtv_pga_target.pga_target      = (data >> Si2141_44_24_DTV_PGA_TARGET_PROP_PGA_TARGET_LSB     ) & Si2141_44_24_DTV_PGA_TARGET_PROP_PGA_TARGET_MASK;
               prop->dtv_pga_target.override_enable = (data >> Si2141_44_24_DTV_PGA_TARGET_PROP_OVERRIDE_ENABLE_LSB) & Si2141_44_24_DTV_PGA_TARGET_PROP_OVERRIDE_ENABLE_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_PGA_TARGET_PROP */
    #ifdef        Si2141_44_24_DTV_RF_AGC_SPEED_PROP
     case         Si2141_44_24_DTV_RF_AGC_SPEED_PROP_CODE:
               prop->dtv_rf_agc_speed.attack = (data >> Si2141_44_24_DTV_RF_AGC_SPEED_PROP_ATTACK_LSB) & Si2141_44_24_DTV_RF_AGC_SPEED_PROP_ATTACK_MASK;
               prop->dtv_rf_agc_speed.decay  = (data >> Si2141_44_24_DTV_RF_AGC_SPEED_PROP_DECAY_LSB ) & Si2141_44_24_DTV_RF_AGC_SPEED_PROP_DECAY_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_RF_AGC_SPEED_PROP */
    #ifdef        Si2141_44_24_DTV_RF_TOP_PROP
     case         Si2141_44_24_DTV_RF_TOP_PROP_CODE:
               prop->dtv_rf_top.dtv_rf_top = (data >> Si2141_44_24_DTV_RF_TOP_PROP_DTV_RF_TOP_LSB) & Si2141_44_24_DTV_RF_TOP_PROP_DTV_RF_TOP_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_RF_TOP_PROP */
    #ifdef        Si2141_44_24_DTV_RSQ_RSSI_THRESHOLD_PROP
     case         Si2141_44_24_DTV_RSQ_RSSI_THRESHOLD_PROP_CODE:
               prop->dtv_rsq_rssi_threshold.lo = (data >> Si2141_44_24_DTV_RSQ_RSSI_THRESHOLD_PROP_LO_LSB) & Si2141_44_24_DTV_RSQ_RSSI_THRESHOLD_PROP_LO_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_RSQ_RSSI_THRESHOLD_PROP */
    #ifdef        Si2141_44_24_DTV_WB_AGC_SPEED_PROP
     case         Si2141_44_24_DTV_WB_AGC_SPEED_PROP_CODE:
               prop->dtv_wb_agc_speed.attack = (data >> Si2141_44_24_DTV_WB_AGC_SPEED_PROP_ATTACK_LSB) & Si2141_44_24_DTV_WB_AGC_SPEED_PROP_ATTACK_MASK;
               prop->dtv_wb_agc_speed.decay  = (data >> Si2141_44_24_DTV_WB_AGC_SPEED_PROP_DECAY_LSB ) & Si2141_44_24_DTV_WB_AGC_SPEED_PROP_DECAY_MASK;
     break;
    #endif /*     Si2141_44_24_DTV_WB_AGC_SPEED_PROP */
    #ifdef        Si2141_44_24_TUNER_BLOCKED_VCO_PROP
     case         Si2141_44_24_TUNER_BLOCKED_VCO_PROP_CODE:
               prop->tuner_blocked_vco.vco_code = (data >> Si2141_44_24_TUNER_BLOCKED_VCO_PROP_VCO_CODE_LSB) & Si2141_44_24_TUNER_BLOCKED_VCO_PROP_VCO_CODE_MASK;
     break;
    #endif /*     Si2141_44_24_TUNER_BLOCKED_VCO_PROP */
    #ifdef        Si2141_44_24_TUNER_BLOCKED_VCO2_PROP
     case         Si2141_44_24_TUNER_BLOCKED_VCO2_PROP_CODE:
               prop->tuner_blocked_vco2.vco_code = (data >> Si2141_44_24_TUNER_BLOCKED_VCO2_PROP_VCO_CODE_LSB) & Si2141_44_24_TUNER_BLOCKED_VCO2_PROP_VCO_CODE_MASK;
     break;
    #endif /*     Si2141_44_24_TUNER_BLOCKED_VCO2_PROP */
    #ifdef        Si2141_44_24_TUNER_BLOCKED_VCO3_PROP
     case         Si2141_44_24_TUNER_BLOCKED_VCO3_PROP_CODE:
               prop->tuner_blocked_vco3.vco_code = (data >> Si2141_44_24_TUNER_BLOCKED_VCO3_PROP_VCO_CODE_LSB) & Si2141_44_24_TUNER_BLOCKED_VCO3_PROP_VCO_CODE_MASK;
     break;
    #endif /*     Si2141_44_24_TUNER_BLOCKED_VCO3_PROP */
    #ifdef        Si2141_44_24_TUNER_LO_INJECTION_PROP
     case         Si2141_44_24_TUNER_LO_INJECTION_PROP_CODE:
               prop->tuner_lo_injection.band_1 = (data >> Si2141_44_24_TUNER_LO_INJECTION_PROP_BAND_1_LSB) & Si2141_44_24_TUNER_LO_INJECTION_PROP_BAND_1_MASK;
               prop->tuner_lo_injection.band_2 = (data >> Si2141_44_24_TUNER_LO_INJECTION_PROP_BAND_2_LSB) & Si2141_44_24_TUNER_LO_INJECTION_PROP_BAND_2_MASK;
               prop->tuner_lo_injection.band_3 = (data >> Si2141_44_24_TUNER_LO_INJECTION_PROP_BAND_3_LSB) & Si2141_44_24_TUNER_LO_INJECTION_PROP_BAND_3_MASK;
     break;
    #endif /*     Si2141_44_24_TUNER_LO_INJECTION_PROP */
     case         Si2141_TUNER_RETURN_LOSS_PROP_CODE:
        if (api->rsp->part_info.part == 41)  /* tuner return loss has different properties for Si2141 and Si2144 */
        {
        ...
        {
            #ifdef        Si2144_TUNER_RETURN_LOSS_PROP
                       prop->tuner_return_loss.reserved   = (data >> Si2144_TUNER_RETURN_LOSS_PROP_RESERVED_LSB  ) & Si2144_TUNER_RETURN_LOSS_PROP_RESERVED_MASK;
    ...
    break;
     ...
     case         Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_CODE:
              if ((api->rsp->part_info.part == 44) || (api->rsp->part_info.part == 24))
              {
               ...
               prop->tuner_return_loss_optimize.thld                = (data >> Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_THLD_LSB               ) & Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_THLD_MASK;
               prop->tuner_return_loss_optimize.config              = (data >> Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_CONFIG_LSB             ) & Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_CONFIG_MASK;
               prop->tuner_return_loss_optimize.engagement_delay    = (data >> Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_ENGAGEMENT_DELAY_LSB   ) & Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_ENGAGEMENT_DELAY_MASK;
               prop->tuner_return_loss_optimize.disengagement_delay = (data >> Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_DISENGAGEMENT_DELAY_LSB) & Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP_DISENGAGEMENT_DELAY_MASK;
     break;
    #endif /*     Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP */
    #ifdef        Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP
     case         Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP_CODE:
              if ((api->rsp->part_info.part == 44) || (api->rsp->part_info.part == 24))
              {
               ...
               prop->tuner_return_loss_optimize_2.thld             = (data >> Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP_THLD_LSB            ) & Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP_THLD_MASK;
               prop->tuner_return_loss_optimize_2.window           = (data >> Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP_WINDOW_LSB          ) & Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP_WINDOW_MASK;
               prop->tuner_return_loss_optimize_2.engagement_delay = (data >> Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP_ENGAGEMENT_DELAY_LSB) & Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP_ENGAGEMENT_DELAY_MASK;
     break;
    #endif /*     Si2141_TUNER_RETURN_LOSS_OPTIMIZE_2_PROP */
    #ifdef        Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP
     case         Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP_CODE:
              if ((api->rsp->part_info.part == 44) || (api->rsp->part_info.part == 24)) /* TF1_BOUNDARY_OFFSET property is not supported in Si2144 */
              {
                  return ERROR_Si2141_44_24_UNKNOWN_PROPERTY;
              }
               prop->tuner_tf1_boundary_offset.tf1_boundary_offset = (data >> Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP_TF1_BOUNDARY_OFFSET_LSB) & Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP_TF1_BOUNDARY_OFFSET_MASK;
     break;
    #endif /*     Si2141_TUNER_TF1_BOUNDARY_OFFSET_PROP */
    #ifdef        Si2141_44_24_WIDE_BAND_ATT_THRS_PROP
     case         Si2141_44_24_WIDE_BAND_ATT_THRS_PROP_CODE:
               prop->wide_band_att_thrs.wb_att_thrs = (data >> Si2141_44_24_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_LSB) & Si2141_44_24_WIDE_BAND_ATT_THRS_PROP_WB_ATT_THRS_MASK;
     break;
    #endif /*     Si2141_44_24_WIDE_BAND_ATT_THRS_PROP */
    #ifdef        Si2141_44_24_XOUT_PROP
     case         Si2141_44_24_XOUT_PROP_CODE:
               prop->xout.amp = (data >> Si2141_44_24_XOUT_PROP_AMP_LSB) & Si2141_44_24_XOUT_PROP_AMP_MASK;
     break;
    #endif /*     Si2141_44_24_XOUT_PROP */
     default : return ERROR_Si2141_44_24_UNKNOWN_PROPERTY; break;
    }
...
/***********************************************************************************************************************
  Si2141_44_24_storePropertiesDefaults function
  Use:        property defaults function
              Used to fill the propShadow structure with startup values.
  Parameter: *prop     the Si2141_44_24_PropObject structure
...
void          Si2141_44_24_storePropertiesDefaults (Si2141_44_24_PropObj   *prop, L1_Si2141_44_24_Context *api) {
  SiTRACE("Si2141_44_24_storePropertiesDefaults\n");
#ifdef    Si2141_44_24_CRYSTAL_TRIM_PROP
...
/***********************************************************************************************************************
  Si2141_44_24_L1_PropertyText function
  Use:        property text function
              Used to turn the property data into clear text.
  Parameter: *prop     the Si2141_44_24 property structure (containing all properties)
...
unsigned char Si2141_44_24_L1_PropertyText          (L1_Si2141_44_24_Context *api,Si2141_44_24_PropObj   *prop, unsigned int prop_code, const char *separator, char *msg) {
    switch (prop_code) {
    #ifdef        Si2144_ACTIVE_LOOP_THROUGH_PROP
     case         Si2144_ACTIVE_LOOP_THROUGH_PROP_CODE:
      sprintf(msg,"ACTIVE_LOOP_THROUGH");
       strcat(msg,separator); strcat(msg,"-ENABLE ");
           if  (prop->active_loop_through.enable ==     0) strcat(msg,"DISABLE ");
      else if  (prop->active_loop_through.enable ==     1) strcat(msg,"ENABLE  ");
      else                                                sprintf(msg,"%s%d", msg,prop->active_loop_through.enable);
     break;
    #endif /*     Si2144_ACTIVE_LOOP_THROUGH_PROP */
    #ifdef        Si2141_44_24_CRYSTAL_TRIM_PROP
     case         Si2141_44_24_CRYSTAL_TRIM_PROP_CODE:
     ...
     case         Si2141_44_24_DTV_IF_AGC_SPEED_PROP_CODE:
      ...
      else                                             sprintf(msg,"%d", prop->dtv_if_agc_speed.decay);
     break;
    #endif /*     Si2141_44_24_DTV_IF_AGC_SPEED_PROP */
    #ifdef        Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP
     case         Si2141_44_24_DTV_INITIAL_AGC_SPEED_PROP_CODE:
     ...
     case         Si2141_44_24_DTV_WB_AGC_SPEED_PROP_CODE:
      ...
      else                                             sprintf(msg,"%d", prop->dtv_wb_agc_speed.attack);
       strcat(msg,separator); strcat(msg,"-DECAY ");
           if  (prop->dtv_wb_agc_speed.decay  ==     0) strcat(msg,"AUTO ");
      else                                             sprintf(msg,"%d", prop->dtv_wb_agc_speed.decay);
     break;
    #endif /*     Si2141_44_24_DTV_WB_AGC_SPEED_PROP */
    #ifdef        Si2141_44_24_TUNER_BLOCKED_VCO_PROP
     case         Si2141_44_24_TUNER_BLOCKED_VCO_PROP_CODE:
    ...
    if (api->rsp->part_info.part == 41)
    {
        ...
        #endif /*     Si2141_44_24_TUNER_RETURN_LOSS_PROP */
    }
    else if ((api->rsp->part_info.part == 24) || (api->rsp->part_info.part == 44))
    {
       #ifdef        Si2144_TUNER_RETURN_LOSS_PROP
          sprintf(msg,"TUNER_RETURN_LOSS");
           strcat(msg,separator); strcat(msg,"-RESERVED ");
           if  (prop->tuner_return_loss.reserved   ==   383) strcat(msg,"RESERVED ");
          else                                                  sprintf(msg,"%s%d", msg,prop->tuner_return_loss.reserved);
           strcat(msg,separator); strcat(msg,"-RETURNLOSS ");
               if  (prop->tuner_return_loss.returnloss ==   112) strcat(msg,"RETURNLOSS_5DB   ");
          else if  (prop->tuner_return_loss.returnloss ==    96) strcat(msg,"RETURNLOSS_5P5DB ");
          else if  (prop->tuner_return_loss.returnloss ==    64) strcat(msg,"RETURNLOSS_6DB   ");
          else if  (prop->tuner_return_loss.returnloss ==    48) strcat(msg,"RETURNLOSS_6P5DB ");
          else if  (prop->tuner_return_loss.returnloss ==    85) strcat(msg,"RETURNLOSS_7DB   ");
          else if  (prop->tuner_return_loss.returnloss ==    69) strcat(msg,"RETURNLOSS_7P5DB ");
          else if  (prop->tuner_return_loss.returnloss ==    90) strcat(msg,"RETURNLOSS_8DB   ");
          else if  (prop->tuner_return_loss.returnloss ==    74) strcat(msg,"RETURNLOSS_8P5DB ");
          else if  (prop->tuner_return_loss.returnloss ==    58) strcat(msg,"RETURNLOSS_9DB   ");
          else if  (prop->tuner_return_loss.returnloss ==    21) strcat(msg,"RETURNLOSS_9P5DB ");
          else if  (prop->tuner_return_loss.returnloss ==    42) strcat(msg,"RETURNLOSS_10DB  ");
          else                                                  sprintf(msg,"%s%d", msg,prop->tuner_return_loss.returnloss);
        #endif /*     Si2144_TUNER_RETURN_LOSS_PROP */
    }
    break;
    #ifdef        Si2141_TUNER_RETURN_LOSS_OPTIMIZE_PROP
     ...
     break;
    #endif /*     Si2141_44_24_XOUT_PROP */
     default : sprintf(msg,"Unknown property code '0x%06x'\n", prop_code); return ERROR_Si2141_44_24_UNKNOWN_PROPERTY; break;
  }
  return NO_Si2141_44_24_ERROR;
}
/***********************************************************************************************************************
  Si2141_44_24_L1_FillPropertyStringText function
...
void          Si2141_44_24_L1_FillPropertyStringText(L1_Si2141_44_24_Context *api, unsigned int prop_code, const char *separator, char *msg) {
  Si2141_44_24_L1_PropertyText (api,api->prop, prop_code, separator, msg);
}
/***********************************************************************************************************************
  Si2141_44_24_L1_GetPropertyString function
...
unsigned char Si2141_44_24_L1_GetPropertyString     (L1_Si2141_44_24_Context *api, unsigned int prop_code, const char *separator, char *msg) {
    int res;
    res = Si2141_44_24_L1_GetProperty2(api,prop_code);
    if (res!=NO_Si2141_44_24_ERROR) { sprintf(msg, "%s",Si2141_44_24_L1_API_ERROR_TEXT(res)); return res; }
    Si2141_44_24_L1_PropertyText(api,api->prop, prop_code, separator, msg);
    return NO_Si2141_44_24_ERROR;
}
