...
//Joey, 20150728, little modification for i2c read/write driver function porting.
//for mark these off, is due to the if write system function call here, need add additional header file including.
//these below 2 function is implemented in tun_si2141.c.
#if 0
/************************************************************************************************************************
...
************************************************************************************************************************/
//Joey, 20150728, little modification for i2c read/write driver function porting.
extern int tun_si2141_read_i2c(L0_Context* i2c, unsigned int iI2CIndex, int iNbBytes, unsigned char *pucDataBuffer);
extern int tun_si2141_write_i2c(L0_Context* i2c, unsigned int iI2CIndex, int iNbBytes, unsigned char *pucDataBuffer);
...
int     L0_ReadBytes         (L0_Context* i2c, unsigned int iI2CIndex, int iNbBytes, unsigned char *pucDataBuffer) {
  ...
  switch (i2c->connectionType) {
    ...
    case CUSTOMER:
      ...
      */      
	nbReadBytes = tun_si2141_read_i2c(i2c, iI2CIndex, iNbBytes, pucDataBuffer);
      break;
    case SIMU:
  ...
  switch (i2c->connectionType) {
    ...
    case CUSTOMER:
      nbWrittenBytes = 0;
        ...
        */        
        return nbWrittenBytes = tun_si2141_write_i2c(i2c, iI2CIndex, iNbBytes, pucDataBuffer);
        break;
    case SIMU:
