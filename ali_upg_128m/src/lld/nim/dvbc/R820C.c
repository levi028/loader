...
UINT8 R828_iniArry[27] = {0x83, 0x32, 0x75, 0xC0, 0x40, 0xB6, 0x6C, 0xD5, 0x63,
                    /*     0x05  0x06  0x07  0x08  0x09  0x0A  0x0B  0x0C  0x0D                                                    */
                          ...
                          //0x75, 0x78, 0x6D, 0x83, 0x80, 0x00, 0x0F, 0x00, 0xC0
...
static UINT8 Xtal_drive = XTAL_DRV_LOW;
//----------------------------------------------------------//
...
R828_ErrCode R828_Xtal_Check(void)
{
    ...
    R828_Arry[11]    = (R828_Arry[11] & 0xFC) | 0x03;
    ...
    if(((R828_I2C_Len.Data[2] & 0x40) == 0x00) || ((R828_I2C_Len.Data[2] & 0x3F) == 0x3F))
    {
        ...
        if(((R828_I2C_Len.Data[2] & 0x40) == 0x00) || ((R828_I2C_Len.Data[2] & 0x3F) == 0x3F))
       {
        ...
        {
           Xtal_cap_sel = XTAL_CAP_20P;
           Xtal_drive = XTAL_DRV_LOW;
        }
    }
    else // 30p lock
    {
        Xtal_cap_sel = XTAL_CAP_30P;
        Xtal_drive = XTAL_DRV_LOW;
    }
...
R828_ErrCode R828_MUX(UINT32 RF_KHz)
{
    ...
    R828_I2C.RegAddr = 0x10;
    R828_Arry[11] &= 0xFC;
    if((Xtal_cap_sel == XTAL_CAP_20P) || (Xtal_cap_sel == XTAL_CAP_30P))
    ...
    //X'tal drive
    R828_I2C.RegAddr = 0x10;
    if(Xtal_drive==XTAL_DRV_LOW)
        R828_Arry[11] = (R828_Arry[11] | 0x08);
    else
        R828_Arry[11] = (R828_Arry[11] & 0xF7);
    R828_I2C.Data    = R828_Arry[11];
    if(I2C_Write(&R828_I2C) != RT_Success)
...
R828_ErrCode R828_SetStandard(R828_Standard_Type RT_Standard)
{
    ...
    // Record Init Flag
    if(R828_IMR_done_flag == TRUE)
        R828_Arry[7]    = (R828_Arry[7] & 0xF0) | 0x01;
    else
...
R828_ErrCode R828_SetFrequency(R828_Set_Info R828_INFO, R828_SetFreq_Type R828_SetFreqMode)
{
     ...
     if((Rafael_Chip==R828D) || (Rafael_Chip==R828))
     {
         if(R828_INFO.R828_Standard>SECAM_L1)  // Limit DTV Xtal CAP = 0pF
         {
               R828_I2C.RegAddr = 0x10;
               R828_Arry[11] = (R828_Arry[11] & 0xFC) | Freq_Info1.XTAL_CAP0P;
               R828_I2C.Data = R828_Arry[11];
               if(I2C_Write(&R828_I2C) != RT_Success)
                    return RT_Fail;
         }
