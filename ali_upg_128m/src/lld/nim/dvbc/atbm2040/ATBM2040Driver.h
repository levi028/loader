...
/*only used in calculate function, when running normal driver comment it.*/
#define ATBM2040_MAX_CALI_REG_NUM 64

#define ATBM2040_ACI_CALIB_REG_GROUP_NUM_MAX (16)
...
typedef struct
{
    UINT32 FreqKHzStart;
    UINT32 FreqKHzEnd;
    ATBM2040RegGroup_t CalResult[ATBM2040_ACI_CALIB_REG_GROUP_NUM_MAX];
#ifdef ATBM2040_CALIBRAT_SIMPLE_REG_MODE
	unsigned int  Calibrate_Reg[ATBM2040_MAX_CALI_REG_NUM];
#endif
}ATBM2040AciCalibration_t;

#define ATBM2040_IIR_COEF_SA_REG_NUM (24)
typedef struct
{
    UINT8 AdcClkDiv8;
    UINT8 iir_coef_sa_8m_3rd_sos[ATBM2040_IIR_COEF_SA_REG_NUM];
    UINT8 iir_coef_sa_10m_3rd_sos[ATBM2040_IIR_COEF_SA_REG_NUM];
}ATBM2040IIRCoefSAParam_t;
...
typedef struct
{
    ...
    ATBM2040IIRCoefSAParam_t *pIIRCoefHmd;
    ATBM2040IIRCoefSAParam_t *pIIRCoefLmd;
    ...
    UINT32 LMDAdcClkHz;
    BOOL AtvAftOpen;
    SINT32 AtvCfoSmoothRatio;
    SINT32 PreAtvCfo;
    SINT32 PreAtvCfoValid;
    ...
    UINT8 bg_lna_100u_con;

    ATBM2040AgcPowerTarget_t *pTargetBak;
    
    ATBM2040_FAST_TUNE_MODE_e FastTuneMD; /*Fast Tune mode*/

    BOOL MultiProcess; /*TRUE: ATBM2040Process may be called in another process */
    BOOL Inited;/*SDK init flag*/
}ATBM2040_t;

#define ATBM2040_ATV_CFO_INVALID_VALUE (10000000)
...
#define ATBM2040_DUPLICATE_TUNE_CHK (0) /* 1: Check duplicate tune and ignore the repeat action; 0: Do not check duplicate tune*/
...
extern void ATBM2040DrvIIRSetting(ATBM2040_t *pTuner);
#endif
