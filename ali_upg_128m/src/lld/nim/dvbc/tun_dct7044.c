...
INT32 tun_dct7044_status(UINT32 tuner_id, UINT8 *lock)
{
    ...
    //result = tuner_dev_ptr->Tuner_Read(tuner_dev_ptr->i2c_type_id, tuner_dev_ptr->c_tuner_base_addr, &data, 1);
...
//==========Write to tuner register===============
    ...
    {
        //result = tuner_dev_ptr->Tuner_Write(tuner_dev_ptr->i2c_type_id, tuner_dev_ptr->c_tuner_base_addr, data,4);
        result = i2c_write(tuner_dev_ptr->i2c_type_id, tuner_dev_ptr->c_tuner_base_addr, data,4);
    }
