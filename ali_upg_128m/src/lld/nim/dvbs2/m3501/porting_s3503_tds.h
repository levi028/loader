#ifndef __PORTING_M3503_TDS_H__
#define __PORTING_M3503_TDS_H__
...
struct nim_s3501_private
{
	...
	INT32   						  (*nim_tuner_command)(UINT32 , INT32 , INT32* );//C3031B Tuner special api function,add by dennis on 20140905
...
extern DWORD   nim_s3501_multu64div(UINT32 v1, UINT32 v2, UINT32 v3);
...
extern UINT32  nim_flag_read(struct nim_s3501_private *priv, UINT32 T1, UINT32 T2, UINT32 T3);
extern UINT32  nim_flag_create(struct nim_s3501_private *priv);
extern UINT32  nim_flag_set(struct nim_s3501_private *priv, UINT32 value);
extern UINT32  nim_flag_clear(struct nim_s3501_private *priv, UINT32 value);
extern UINT32  nim_flag_del(struct nim_s3501_private *priv);
