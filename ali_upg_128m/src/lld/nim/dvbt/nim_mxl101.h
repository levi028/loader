...
//MxL101SF_OEM_Drv.h end


//MxL101SF_PhyCtrlApi.h
/******************************************************************************
    Macros
******************************************************************************/
...
// MxL101SF_OEM_Drv.h specific APIs
MXL_STATUS Ctrl_WriteRegister(UINT32 tuner_id, UINT8 regAddr, UINT8 regData);
...
/* MXL101_TPS*/
#define MXL101_HP 0 << 15

#define MXL101_FEC_1_2   0 << 7
#define MXL101_FEC_2_3   1 << 7
#define MXL101_FEC_3_4   2 << 7
#define MXL101_FEC_5_6   3 << 7
#define MXL101_FEC_7_8   4 << 7

#define MXL101_GUARD_1_32 0 <<2
#define MXL101_GUARD_1_16 1 <<2
#define MXL101_GUARD_1_8  2 <<2
#define MXL101_GUARD_1_4  3 <<2

#define MXL101_MODE_2K    0
#define MXL101_MODE_8K   1

#define  MXL101_MODU_QPSK  0  <<13
#define  MXL101_MODU_16QAM 1 <<13
#define  MXL101_MODU_64QAM 2 <<13
...
struct nim_MXL101_private
{
    struct COFDM_TUNER_CONFIG_API Tuner_Control;
    UINT32 tuner_id;
};

static INT32 f_MXL101_read(UINT32 tuner_id, UINT8 dev_add, UINT8 reg_add, UINT8 *data, UINT8 len);
static INT32 f_MXL101_write(UINT32 tuner_id, UINT8 dev_add, UINT8 reg_add, UINT8 *data, UINT8 len);
INT32 f_MXL101_attach();
void f_MXL101_hw_init();
void f_MXL101_hardware_reset();
void f_MXL101_after_reset_set_param();
static INT32 f_MXL101_open(struct nim_device *dev);
static INT32 f_MXL101_close(struct nim_device *dev);
static INT32 f_MXL101_disable(struct nim_device *dev);//Sam
void     f_MXL101_dump_register();
...
static INT32 f_MXL101_get_BER(struct nim_device *dev, UINT32 *RsUbc);
...
static INT32 f_MXL101_get_bandwidth(struct nim_device *dev, UINT8 *bandwidth);
static INT32 f_MXL101_get_RFLevel(struct nim_device *dev, INT32  *RFlevel);
static INT32 f_MXL101_Tracking(struct nim_device *dev);
static INT32 f_MXL101_get_specinv(struct nim_device *dev, UINT8 *Inv);
static INT32 f_MXL101_i2c_bypass(struct nim_device *dev);
...
static INT32 f_MXL101_ioctl_ext(struct nim_device *dev, INT32 cmd, void* param_list);

static INT32 f_MXL101_init_reg(struct nim_device *dev);//051124 yuchun
static INT32 f_MXL101_freq_offset(struct nim_device *dev, UINT32 bandwidth, UINT8 fft_mode, INT32 *freq_offset);//051124 yuchun
static INT32 f_MXL101_getinfo(struct nim_device *dev, UINT8 *code_rate, UINT8 *guard_interval, UINT8 *fft_mode, UINT8 *modulation);//051124 yuchun
...
void f_MXL101_Core_Switch(struct nim_device *dev);
INT32 f_MXL101_get_TRLNOMRATE(struct nim_device *dev);
void f_MXL101_set_TRLNOMRATE(struct nim_device *dev,UINT32  value);
INT32 f_MXL101_TRLNOMRATE_Tuning(struct nim_device *dev);
void f_MXL101_dump_reg(struct nim_device *dev);
...
#define MXL101_FECSTAT_LOCKED        0x30
#define MXL101_LOGIC_ENABLE        0x01

/* LOCK IMFO   */
#define MXL101_TUNER_LOCK_FLAG              0x40
#define MXL101_SYMBOL_LOCK_FLAG        0x02
#define MXL101_OFDM_LOCK_FLAG              0x03
#define MXL101_FEC_LOCK_FLAG                  0x30
/*set OFDM_WAIT_TIME    */
#define MXL101_OFDM_8K_WAIT               0x40
