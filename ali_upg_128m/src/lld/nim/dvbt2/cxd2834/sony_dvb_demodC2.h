...
-----------------------------------------------------------------------------*/
/**
 @brief Tuning parameters specific to DVB-C2.
*/
...
typedef struct sony_dvbc2_dataSlice_t {
    ...
    */
    ...
    /**
     @brief Value indicating if dependant Data Slice
    */
    ...
    */
    ...
    /**
     @brief Data for Dependant static Data Slice; tune to first Datalice information
    */
    sony_dvbc2_stf_data_t stf;

    /**
     @brief Data Slice initial RF tune centre frequency in kHz
    */
...
typedef struct sony_dvbc2_tune_seq_t {
    ...
    sony_dvbc2_tune_params_t *pTuneData;            /**< C2 dependant tune parameters */
