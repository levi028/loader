...
/**
 @brief Monitor the SNR of the DVB-C2 demodulator.
...
/**
 ...
 @param pDemod The demodulator instance.
 @param pMER The returned MER in dB x 1000. Deprecated. Maps to ::sony_dvb_demod_monitorC2_SNR.
...
/**
 @brief Monitor the DVB-C2 PER (Packet Error Rate) parameters.
