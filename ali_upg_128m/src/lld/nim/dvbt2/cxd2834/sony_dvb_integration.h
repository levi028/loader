...
/**
 @brief Callback function that is called for every attempted frequency during a
        ...
        - DVB-T: This callback is invoked when TPS lock is achieved.
                 Use ::sony_dvb_integration_WaitTSLock to wait for TS lock.
...
/**
 ...
 @brief Construct the driver.
        ...
        This MUST be called before calling ::sony_dvb_integration_Initialize.
        ...
        - By default, the demodulator uses an inverted AGC.
          ...
          ::sony_dvb_demod_SetConfig with ::DEMOD_CONFIG_IFAGCNEG = 0 to setup
        ...
        - By default, the driver enables the RF level monitoring on the
          device, call ::sony_dvb_demod_SetConfig with ::DEMOD_CONFIG_RFLVMON_ENABLE = 0
          to disable it, after calling ::sony_dvb_integration_Initialize.
 ...
 @param pInteg The driver to create.
...
/**
 @brief Performs a scan over the spectrum of interest.
        ...
        Blocks the calling thread while scanning. Use ::sony_dvb_integration_Cancel to cancel
...
/**
 @brief Performs a blind acquisition to the channel. Blocks the calling thread
        ...
        Use ::sony_dvb_integration_Cancel to cancel the operation at any time.
        ...
        - DVBT2: Acquisition waits for demod lock (P1/L1-pre/L1-post).
          Once successful, the application can wait for TS lock (::sony_dvb_integration_WaitTSLock)
          ...
          ::sony_dvb_demod_monitorT2_DataPLPs.
          Once acquired, use ::sony_dvb_demod_monitorT2_SpectrumSense to see which sense was detected.
...
/**
 @brief Cancel any pending operations on the demod.
        Cancels ::sony_dvb_integration_BlindTune, ::sony_dvb_integration_Tune
                and ::sony_dvb_integration_Scan and ::sony_dvb_integration_WaitTSLock.
