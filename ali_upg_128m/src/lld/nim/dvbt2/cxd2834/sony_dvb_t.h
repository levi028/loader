    ...
    */
    ...
    /**
     @brief Indicates whether the following (mode and gi) preset
            ...
            - 1: ::sony_dvbt_tune_params_t::mode and ::sony_dvbt_tune_params_t::gi are
               forced in the demodulator. The mode and guard can be retrieved from
               ::sony_dvb_demod_monitorT_TPSInfo.
            - 0: ::sony_dvbt_tune_params_t::mode and sony_dvbt_tune_params_t::gi are
               ignored.
    */
    uint8_t usePresets;
