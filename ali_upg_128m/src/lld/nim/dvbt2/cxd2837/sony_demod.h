...
#define SONY_DVBT_5MHz_IF           5.00
#define SONY_DVBT_6MHz_IF           5.00
#define SONY_DVBT_7MHz_IF           5.00
#define SONY_DVBT_8MHz_IF           5.00
#define SONY_DVBT2_1_7MHz_IF        5.00
#define SONY_DVBT2_5MHz_IF          5.00
#define SONY_DVBT2_6MHz_IF          5.00
#define SONY_DVBT2_7MHz_IF          5.00
#define SONY_DVBT2_8MHz_IF          5.00
...
typedef struct sony_demod_t {
	...
	UINT8 t2_signal;			//current  signal type 0:ISDBT,1:DVB-T signal, 2:DVB-T2 signal.,3:combo signal
	UINT8 sys_signal_type;        //system signal type 0:ISDBT,1:DVB-T signal, 2:DVB-T2 signal.,3:combo signal
