...
------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------
 Based on ASCOT2E application note 2.3.0
------------------------------------------------------------------------------*/
...
static const sony_ascot2e_adjust_param_t g_param_table[SONY_ASCOT2E_TV_SYSTEM_NUM] = {
    ...
    {0, 0, 0x03, AUTO, 0x06, OFFSET(-8), OFFSET(-6), BW_6,  0x0B, 0x00}, /**< SONY_ASCOT2E_DTV_DVBT_5    (DVB-T 5MHzBW) */
    {0, 0, 0x03, AUTO, 0x06, OFFSET(-8), OFFSET(-6), BW_6,  0x0B, 0x00}, /**< SONY_ASCOT2E_DTV_DVBT_6    (DVB-T 6MHzBW) */
    {0, 0, 0x03, AUTO, 0x06, OFFSET(-6), OFFSET(-4), BW_7,  0x0B, 0x00}, /**< SONY_ASCOT2E_DTV_DVBT_7    (DVB-T 7MHzBW) */
    {0, 0, 0x03, AUTO, 0x06, OFFSET(-4), OFFSET(-2), BW_8,  0x0B, 0x00}, /**< SONY_ASCOT2E_DTV_DVBT_8    (DVB-T 8MHzBW) */
    {0, 0, 0x03, AUTO, 0x06, OFFSET(-10),OFFSET(-16),BW_1_7,0x0B, 0x00}, /**< SONY_ASCOT2E_DTV_DVBT2_1_7 (DVB-T2 1.7MHzBW) */
    {0, 0, 0x03, AUTO, 0x06, OFFSET(-8), OFFSET(-6), BW_6,  0x0B, 0x00}, /**< SONY_ASCOT2E_DTV_DVBT2_5   (DVB-T2 5MHzBW) */
    {0, 0, 0x03, AUTO, 0x06, OFFSET(-8), OFFSET(-6), BW_6,  0x0B, 0x00}, /**< SONY_ASCOT2E_DTV_DVBT2_6   (DVB-T2 6MHzBW) */
    {0, 0, 0x03, AUTO, 0x06, OFFSET(-6), OFFSET(-4), BW_7,  0x0B, 0x00}, /**< SONY_ASCOT2E_DTV_DVBT2_7   (DVB-T2 7MHzBW) */
    {0, 0, 0x03, AUTO, 0x06, OFFSET(-4), OFFSET(-2), BW_8,  0x0B, 0x00}, /**< SONY_ASCOT2E_DTV_DVBT2_8   (DVB-T2 8MHzBW) */
    {0, 0, 0x02, AUTO, 0x03, OFFSET(-2), OFFSET(-1), BW_8,  0x09, 0x00}, /**< SONY_ASCOT2E_DTV_DVBC      (DVB-C) */
...
/**
 @brief Configure the ASCOT2E tuner to Power Save state.
*/
static sony_result_t X_fin(sony_ascot2e_t *pTuner);
/**
 @brief Configure the ASCOT2E tuner to Oscillation Stop state.
*/
static sony_result_t X_oscdis(sony_ascot2e_t *pTuner);
/**
 @brief Configure the ASCOT2E tuner back from Oscillation Stop state.
*/
...
static sony_result_t X_oscdis(sony_ascot2e_t *pTuner)
{
    ...
    /* Xtal oscillator current control setting */
    result = pTuner->pI2c->WriteOneRegister(pTuner->pI2c, pTuner->i2cAddress, 0x4C, 0x00);
    if(result != SONY_RESULT_OK){ SONY_TRACE_RETURN(SONY_RESULT_ERROR_I2C); }

    /* XOSC_SEL setting */
    result = pTuner->pI2c->WriteOneRegister(pTuner->pI2c, pTuner->i2cAddress, 0x07, 0x00);
    if(result != SONY_RESULT_OK){ SONY_TRACE_RETURN(SONY_RESULT_ERROR_I2C); }
