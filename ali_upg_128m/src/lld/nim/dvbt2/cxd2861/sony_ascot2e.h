...
*/
#define SONY_ASCOT2E_VERSION     "1.0.8.0"
...
typedef struct sony_ascot2e_adjust_param_t {
    ...
    uint8_t BW_OFFSET;    /**< Addr:0x0F Bit[4:0] : 5bit signed. BW offset (kHz) = BW_OFFSET x 50 (BW_OFFSET x 10 in 1.7MHzBW) */
    uint8_t BW;           /**< Addr:0x12 Bit[5:4] : 6MHzBW(0x00) or 7MHzBW(0x01) or 8MHzBW(0x02) or 1.7MHzBW(0x03) */
...
/**
 @brief Use external Xtal
        Should be used for slave ASCOT2E in Xtal shared system.
*/
#define SONY_ASCOT2E_CONFIG_EXT_REF            0x80000000

/**
 @brief Disable Xtal in Sleep state.
        Should NOT be used for Xtal shared system.
        Not only for the master ASCOT2E which has Xtal, but also slave ASCOT2E which receive the clock signal.
        Cannot be used with SONY_ASCOT2E_CONFIG_EXT_REF.
*/
#define SONY_ASCOT2E_CONFIG_SLEEP_DISABLEXTAL  0x40000000
