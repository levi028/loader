...
sony_result_t sony_tuner_ascot2e_Create (uint32_t xtalFreqMHz,uint8_t i2cAddress, UINT32 i2c_type_id, uint32_t configFlags);
...
/**
 @brief Calculate the IF and RF gain levels from demod AGC value.

 @param pTuner  Instance of the tuner driver.
 @param agcReg  Demod AGC register value.
 @param pIFGain IF gain of the tuner in dB * 100      
 @param pRFGain RF gain of the tuner in dB * 100
