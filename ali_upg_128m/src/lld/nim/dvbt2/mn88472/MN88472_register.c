...
'12/01/19 : OKAMOTO    Update to "MN88472_Device_Driver_120116".
'12/01/18 : OKAMOTO    Implement IF 4MHz for DVB-T/T2 6MHz.
'11/12/27 : OKAMOTO    Update to "MN88472_Device_Driver_111220".
'11/11/09 : OKAMOTO    Correct IF freq setting for DVB-T/T2 8/7MHz.
...
#if ( defined(SYS_DVBT_DEMO_MODULE) && defined(CDT_MN88472_MXL603) )
    #if ( SYS_DVBT_DEMO_MODULE == CDT_MN88472_MXL603 )
        #define DMD_XTAL_FREQ    DMD_XTAL24000KHZ_IF5MHZ    //for full nim: CDT_MN88472_MXL603
    #endif
#endif

#if ( ! defined(DMD_XTAL_FREQ) )
    #define DMD_XTAL_FREQ    DMD_XTAL20480KHZ_IF5MHZ //for Ali demo board: BOARD_DB_C3047_T2_01V01, recommended by Panasonic.
#endif

#if (DMD_XTAL_FREQ == DMD_XTAL20480KHZ_IF5MHZ)

DMD_u32_t DMD_RegSet_Rev = 120613;
...
DMD_I2C_Register_t    MN88472_REG_COMMON[] = {
    ...
    { 0x18 , 0xB0 , 0x9 , DMD_E_ARRAY },    //Improve DVB-T2 performance according to the MXL603 EVB. ADC input range //1v[p-p](2st register(T):ADCSET1)
    #else
    { 0x18 , 0xB0 , 0xA , DMD_E_ARRAY },    //ADC input range //1.5v[p-p](2st register(T):ADCSET1)
    #endif
...
#elif (DMD_XTAL_FREQ == DMD_XTAL24000KHZ_IF5MHZ)
...
DMD_u32_t DMD_RegSet_Rev = 120116;
...
DMD_I2C_Register_t    MN88472_REG_COMMON[] = {
    ...
    { 0x1c , 0xEA , 0x0 , DMD_E_ARRAY },
    { 0x1c , 0xEB , 0x0 , DMD_E_ARRAY },
    { 0x1c , 0xEC , 0x53 , DMD_E_ARRAY },//troy.wangyx, 20120801, 0xD3->0x53, only need do once for TCB I2C mode setting.
    { 0x1c , 0xED , 0x31 , DMD_E_ARRAY },
    { 0x1c , 0xEE , 0x0 , DMD_E_ARRAY },
    { 0x1c , 0xEF , 0x0 , DMD_E_ARRAY },
    { 0x1c , 0xF0 , 0x0 , DMD_E_ARRAY },
...
#elif (DMD_XTAL_FREQ == DMD_XTAL20500KHZ_IF5MHZ)
...
DMD_I2C_Register_t    MN88472_REG_COMMON[] = {
    ...
    { 0x18 , 0xAE , 0x0 , DMD_E_ARRAY },
    { 0x18 , 0xAF , 0x0 , DMD_E_ARRAY },
//This ¡°ADCSET1¡± register is directly controlling the ADC input voltage range (IF signal), and related to CN,
//which is the most possible and priority number one to be verified.
//The register settings are both legal, but needs to be coupled with tuner.
//Note there are Differential and Single signal types, also there is an external capacitive coupling.
//There is no definite optimal values, but needs a checking to try out the best with the coupled Tuner.
    #if (SYS_TUN_MODULE == MXL603)
    { 0x18 , 0xB0 , 0x9 , DMD_E_ARRAY },    //EVK: ADC input range //1v[p-p](2st register(T)::ADCSET1  addr:B0 )
    #else
    { 0x18 , 0xB0 , 0xA , DMD_E_ARRAY },    //ADC input range //1.5v[p-p](2st register(T)::ADCSET1  addr:B0 )
    #endif
    { 0x18 , 0xB1 , 0x7A , DMD_E_ARRAY },
    { 0x18 , 0xB2 , 0x40 , DMD_E_ARRAY },
    { 0x18 , 0xB3 , 0x5C , DMD_E_ARRAY },
...
// File : MN88472_DIFF_DVBT2_7MHz_120116.rgs
// Date : 2012/01/16
// Time : 16:38:28
// Comment : fXtal=20.5MHz, fIF=5MHz, TS Parallel
//
...
// File : MN88472_DIFF_DVBT_6MHz_120116.rgs
// Date : 2012/01/16
// Time : 16:38:29
// Comment : fXtal=20.5MHz, fIF=5MHz, TS Parallel
//
...
// File : MN88472_DIFF_DVBT_7MHz_120116.rgs
// Date : 2012/01/16
// Time : 16:38:29
// Comment : fXtal=20.5MHz, fIF=5MHz, TS Parallel
//
...
// File : MN88472_DIFF_DVBT2_6MHz_120116.rgs
// Date : 2012/01/16
// Time : 16:38:28
// Comment : fXtal=20.5MHz, fIF=5MHz, TS Parallel
//
...
// File : MN88472_DIFF_DVBT2_8MHz_120116.rgs
// Date : 2012/01/16
// Time : 16:38:28
// Comment : fXtal=20.5MHz, fIF=5MHz, TS Parallel
//
...
#if (SYS_TUN_MODULE == MXL603)
    { 0x1c , 0x10 , 0x3E , DMD_E_ARRAY },   //DMD_NCOFREQU
    { 0x1c , 0x11 , 0x70 , DMD_E_ARRAY },   //DMD_NCOFREQM
    { 0x1c , 0x12 , 0x64 , DMD_E_ARRAY },   //DMD_NCOFREQL

    { 0x1c , 0x13 , 0x8F , DMD_E_ARRAY },   //DMD_FADU
    { 0x1c , 0x14 , 0x80 , DMD_E_ARRAY },   //DMD_FADM
    { 0x1c , 0x15 , 0x0  , DMD_E_ARRAY },   //DMD_FADL

    { 0x1c , 0x16 , 0x08 , DMD_E_ARRAY },   //DMD_FSFTXU
    { 0x1c , 0x17 , 0xEE , DMD_E_ARRAY },   //DMD_FSFTXL
    { 0x1c , 0x18 , 0x08 , DMD_E_ARRAY },   //DMD_FSFTYU
    { 0x1c , 0x19 , 0xEE , DMD_E_ARRAY },   //DMD_FSFTYL
#else    //(SYS_TUN_MODULE == MXL301)
    { 0x1c , 0x10 , 0x3E , DMD_E_ARRAY },
    { 0x1c , 0x11 , 0x70 , DMD_E_ARRAY },
    { 0x1c , 0x12 , 0x64 , DMD_E_ARRAY },
...
// File : MN88472_DIFF_DVBT2_5MHz_120116.rgs
// Date : 2012/01/16
// Time : 16:38:28
// Comment : fXtal=20.5MHz, fIF=5MHz, TS Parallel
//
...
// File : MN88472_DIFF_DVB-T2_1.7MHz_IF5MHz_120116.rgs
// Date : 2012/01/16
// Time : 16:38:28
// Comment : fXtal=20.5MHz, fIF=5MHz, TS Parallel
//
...
// File : MN88472_DIFF_DVBC_120116.rgs
// Date : 2012/01/16
// Time : 16:38:29
// Comment : fXtal=20.5MHz, fIF=5MHz, TS Parallel
//
...
// File : MN88472_DIFF_DVBT_8MHz_120116.rgs
// Date : 2012/01/16
// Time : 16:38:29
// Comment : fXtal=20.5MHz, fIF=5MHz, TS Parallel
//
...
#else
    #error "DMD_XTAL_FREQ had not been defined for MN88472."
#endif
