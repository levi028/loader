...
'11/10/19 : OKAMOTO	Correct warning: useless storage class specifier in empty declaration
...
#define DMD_ERR_STR_SIZE	16
extern const char g_dmd_err_str[DMD_ERROR_MAX][DMD_ERR_STR_SIZE];
...
typedef struct {
    ...
    UINT32 do_not_wait_t_signal_locked  :1;
    UINT32 reserved                     :29;
...
typedef	enum	{	DMD_E_INFO_DVBT2_ALL	=0	,	
			...
			DMD_E_INFO_DVBT2_SELECTED_PLP,  //19
			...
			DMD_E_INFO_DVBT2_T2_SYSTEM_ID,  //35
			...
			DMD_E_INFO_DVBT2_DAT_PLP_TYPE,  //51
