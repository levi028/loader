                    ...
                    )
{
    ...
    switch(Mode)
    {
        ...
        case MxL_MODE_ANA_MN:
            ...
            SetIRVBit(myIRV, 0x57, 0xFF, 0x61);                    /* V9.4.6.0 */
            SetIRVBit(myIRV, 0x55, 0xFF, 0x12);                /* V9.4.6.0 */
            SetIRVBit(myIRV, 0x56, 0xFF, 0x47);                /* V9.4.6.0 */
#endif
        break;
    ...
    switch(IF_Freq_Hz)
    {
        case MxL_IF_3_65_MHZ:                    /* Added for TDA8296 demod for M/N mode */
        ...
        case MxL_IF_4_MHZ:
            ...
            SetIRVBit(myIRV, 0xAF, 0xFF, 0xA2);
            break;
        case MxL_IF_4_1_MHZ:                    /* Added for TDA8296 demod for M/N mode */
            SetIRVBit(myIRV, 0x02, 0x0F, 0x00);
            SetIRVBit(myIRV, 0xAF, 0xFF, 0xA2);
            ...
            break;
        case MxL_IF_4_15_MHZ:                    /* Added for TDA8296 demod for M/N mode */
            SetIRVBit(myIRV, 0x02, 0x0F, 0x00);
            SetIRVBit(myIRV, 0xAF, 0xFF, 0xA2);
    ...
    switch(Mode)
    {
        ...
        case MxL_MODE_ANA_I:
            {    /* Added V9.4.2.0 */
                ...
                else if (((RF_Freq >= 761.5*MHz) && (RF_Freq <= 762.5*MHz)) || ((RF_Freq >= 785.5*MHz) && (RF_Freq <= 786.5*MHz)) || ((RF_Freq >= 809.5*MHz) && (RF_Freq <= 810.5*MHz))
                        ||((RF_Freq >= 833.5*MHz) && (RF_Freq <= 834.5*MHz))|| ((RF_Freq >= 857.5*MHz) && (RF_Freq <= 858.5*MHz)) || ((RF_Freq >= 881.5*MHz) && (RF_Freq <= 882.5*MHz)))
                {
