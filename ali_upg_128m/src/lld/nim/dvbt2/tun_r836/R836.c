...
UINT8 R840_iniArray[R840_REG_NUM] = {0x02, 0x44, 0x40, 0x40, 0x04,      
					...
					//     0x05  0x06  0x07  0x08  0x09  0x0A  0x0B  0x0C  0x0D                                                    	   
						   ...
						   0x95, 0x94, 0x63, 0x02, 0x72, 0x00, 0x0B, 0xAA, 0xAA,  
...
UINT8 R840_Xtal_Pwr = XTAL_NOR_HIGHEST;
UINT8 R840_Xtal_Pwr_tmp = XTAL_NOR_HIGHEST;
...
//0: NC/L82n(china DVB-C)
//1: L270n/68n(ATSC, ISDB-T, DVB-T/T2)
//2: Bead/68n(DTMB)
//3: L270n/68n(DVB-C, J83B)
//4: L270n/68n(ATV)
//5: Bead/68n(DTMB+ATV)
UINT32 R840_LNA_HIGH_MID[R840_TF_SIZE] = {644000, 644000, 644000, 644000, 644000, 644000}; 
UINT32 R840_LNA_MID_LOW[R840_TF_SIZE] = {348000, 388000, 388000, 348000, 348000, 348000};
UINT32 R840_LNA_LOW_LOWEST[R840_TF_SIZE] = {108000, 164000, 164000, 148000, 124000, 124000};
...
{    {296000, 280000, 256000, 216000, 184000, 168000, 136000, 112000},  //108~348
...
{    {0x00, 0x06, 0x0C, 0x15, 0x1C, 0x1F, 0x3C, 0x3F}, //no use, RF freq>115MHz
...
Sys_Info_Type R840_Sys_Sel(R840_Standard_Type R840_Standard)
{
	...
	case R840_DVB_C_CHINA:   //RF>115MHz
	...
	case R840_DVB_C_6M:  
		R840_Sys_Info.IF_KHz=5070;
		R840_Sys_Info.BW=0x40;                          //BW=7M
		R840_Sys_Info.FILT_CAL_IF=8150;          //CAL IF   
	...
	case R840_ATSC:  
		R840_Sys_Info.IF_KHz=5070;
		R840_Sys_Info.BW=0x40;                          //BW=7M  
		R840_Sys_Info.FILT_CAL_IF=7750;          //CAL IF     20130621 Ryan Modify
		R840_Sys_Info.HPF_COR=0x03;	             //R11[3:0]=3  
	...
	case R840_DVB_C_CHINA_IF_5M:   //RF>115MHz
		R840_Sys_Info.IF_KHz=5000;
		R840_Sys_Info.BW=0x00;                           //BW=8M
		R840_Sys_Info.FILT_CAL_IF=9150;           //CAL IF 
		R840_Sys_Info.HPF_COR=0x0A;	             //R11[3:0]=10
		R840_Sys_Info.FILT_EXT_ENA=0x10;      //R11[4]=1, ext enable
		R840_Sys_Info.FILT_EXT_WIDEST=0x00;//R30[2]=0, ext normal
		R840_Sys_Info.FILT_EXT_POINT=0x02;   //R30[1:0]=10, lna=max-1 & Buf 4, hpf+3
	...
	//Filter 3dB
	if((R840_Standard==R840_DVB_C_8M_IF_5M) || (R840_Standard==R840_DVB_C_CHINA_IF_5M) ||
		(R840_Standard==R840_DVB_C_8M_W_DTMB_IF_5M))
	...
	switch(R840_Standard)
	{
		case R840_DVB_C_CHINA:
		case R840_DVB_C_CHINA_IF_5M:
			    R840_SetTfType = R840_TF_DVBC_CHINA;
			 break;		
		...
		case R840_DVB_C_6M_IF_5M:
		case R840_J83B_IF_5M:
			    R840_SetTfType = R840_TF_NARROW_LIN;		
			 break;	

		default:		//DVB-T/T2, ISDB-T, ATSC
...
SysFreq_Info_Type R840_SysFreq_Sel(R840_Standard_Type R840_Standard,UINT32 RF_freq)
{
	...
	case R840_DVB_C_CHINA:             //NC/82n
    case R840_DVB_C_CHINA_IF_5M: //NC/82n
	...
	case R840_ISDB_T_IF_5M:	
		...
		{
			R840_SysFreq_Info.LNA_TOP=0x02;		       // LNA TOP=5                    (R27[2:0]=3'b010)
			R840_SysFreq_Info.LNA_VTH_L=0x72;		   // LNA VTH/L=1.04/0.54     (R13=0x72)
			R840_SysFreq_Info.MIXER_TOP=0x05;	       // MIXER TOP=10               (R28[3:0]=4'b0100)
			R840_SysFreq_Info.MIXER_VTH_L=0x95;   // MIXER VTH/L=1.24/0.84  (R14=0x95)
			R840_SysFreq_Info.RF_TOP=0x60;               // RF TOP=4                        (R26[7:5]=3'b011)
	...
	case R840_ATSC_IF_5M:
			...
			R840_SysFreq_Info.MIXER_VTH_L=0xB7;   // MIXER VTH/L=1.44/1.04  (R14=0xB7)
			R840_SysFreq_Info.RF_TOP=0x20;               // RF TOP=6                        (R26[7:5]=3'b001)
			R840_SysFreq_Info.NRB_TOP=0x20;            // Nrb TOP=13                       (R28[7:4]=4'b0010)
			R840_SysFreq_Info.NRB_BW=0x80;             // Nrb BW=low                      (R27[7:6]=2'b10)
		break;
...
R840_ErrCode R840_Init(void)
{
	...
	if(R840_Initial_done_flag==FALSE)
	{
		  ...
		  R840_Xtal_Pwr = XTAL_NOR_LOWEST;
		  R840_Xtal_Pwr_tmp = XTAL_NOR_LOWEST;
...
R840_ErrCode R840_Xtal_Check(void)
{
	...
	R840_Array[15] = (R840_Array[15] & 0x87) | 0x60;
	...
	for(i=0; i<XTAL_CHECK_SIZE; i++)
	{
		...
		if(i<=XTAL_NOR_HIGHEST)
			R840_Array[15] = (R840_Array[15] & 0x87) | ((UINT8)(XTAL_NOR_HIGHEST-i)<<5) | 0x00;  //normal Gm
		else if(i==XTAL_GM3V_HIGHEST)
			R840_Array[15] = (R840_Array[15] & 0x87) | 0x00 | 0x18;  //3v Gm, highest
		else
            R840_Array[15] = (R840_Array[15] & 0x87) | 0x00 | 0x10;  //2v Gm, highest
...
R840_ErrCode R840_Cal_Prepare(UINT8 u1CalFlag)
{
	 ...
	 switch(u1CalFlag)
	 {
	  ...
	  R840_Array[30] = (R840_Array[30] & 0xF7) | Cal_Info.FILTER_6DB;
...
R840_ErrCode R840_PLL(UINT32 LO_Freq, R840_Standard_Type R840_Standard)
{
	...
	else
	{
		...
		else
		{
		    XTAL_POW1 = 0x00;        //high,       R16[4]=0
			XTAL_POW0 = 0x00;        //highest,   R15[6:5]=00
			XTAL_GM = 0x10;            //2V,         R15[4:3]=10
		}
	}
	R840_I2C.RegAddr = 0x0F;
	R840_Array[15] = (R840_Array[15] & 0x87) | XTAL_POW0 | XTAL_GM; 
	R840_I2C.Data = R840_Array[15];
	if(I2C_Write(&R840_I2C) != RT_Success)
	    return RT_Fail;
	...
	if(VCO_current_trial==2)
	{
		...
		if( (R840_I2C_Len.Data[2] & 0x40) == 0x00) 
		{
			...
			R840_I2C.RegAddr = 0x0F;
			R840_Array[15] = (R840_Array[15] & 0xE7) | XTAL_GM; 
			R840_I2C.Data = R840_Array[15];
			if(I2C_Write(&R840_I2C) != RT_Success)
				return RT_Fail;
		}
...
{	 
   ...
   // Set Filter 3dB
	...
	// Record init flag
	R840_I2C.RegAddr = 0x1A;
	R840_Array[26] = (R840_Array[26] & 0xF0) | (R840_Initial_done_flag<<1) | (R840_Fil_Cal_flag[RT_Standard]<<2) | R840_IMR_done_flag;  
    R840_I2C.Data = R840_Array[26];
    if(I2C_Write(&R840_I2C) != RT_Success)
       return RT_Fail;
